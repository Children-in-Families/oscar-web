CIF.UsersShow = do ->
  ...
  _autoCheckReadable = ->
    ...
    $('.user_permission_specific_referral_data_editable input.i-checks').on 'ifChecked', (event) ->
      $(@).parents('.specific-referral-data-permission').find('.user_permission_specific_referral_data_readable input.i-checks').iCheck('check')
  ...
  _autoUncheckEditable = ->
    ...
    $('.user_permission_specific_referral_data_readable input.i-checks').on 'ifUnchecked', (event) ->
      $(@).parents('.specific-referral-data-permission').find('.user_permission_specific_referral_data_editable input.i-checks').iCheck('uncheck')
