...
export default (props) => {
  ...
  const answeredCallOpts = [
    ...
    {
      label: T.translate(
        "newCall.refereeInfo.answeredCallOpts.return_missed_call"
      ),
      value: false,
    },
  ];
      ...
      $.ajax({
        ...
        .success((response) => {
          ...
          const message = T.translate(
            "editCall.index.message.call_has_been_updated"
          );
  ...
  const handleValidation = () => {
    const validationFields = seekingInformation
      ? [
          "receiving_staff_id",
          "date_of_call",
          "start_datetime",
      ...
      : ["receiving_staff_id", "date_of_call", "start_datetime"];
    const errors = [];
          ...
          <div className="col-xs-12 col-md-6">
            <TextArea
              ...
              placeholder={T.translate(
                "newCall.admin.add_note_about_the_content"
              )}
      ...
      <div className="row">
        <div className="col-sm-12 text-right">
          <span className="btn btn-success form-btn" onClick={handleSave}>
            {T.translate("editCall.index.save")}
          </span>
          <span className="btn btn-default form-btn" onClick={handleCancel}>
            {T.translate("editCall.index.cancel")}
          </span>
        </div>
      </div>
    </>
