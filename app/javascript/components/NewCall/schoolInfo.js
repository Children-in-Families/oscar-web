    ...
    <div id={id} className="collapse">
      ...
      <div className="row">
        <div className="col-xs-12 col-md-6 col-lg-3">
          <TextInput T={T} label="School Name" onChange={handleOnChangeText('school_name')} value={client.school_name}/>
        </div>
        <div className="col-xs-12 col-md-6 col-lg-3">
          <SelectInput
            T={T}
        ...
        <div className="col-xs-12 col-md-6 col-lg-3">
          <TextInput T={T} label="Main School Contact" onChange={handleOnChangeText('main_school_contact')} value={client.main_school_contact} />
        </div>
      </div>
    </div>
  )
