...
export default props => {
  const { onChange, data: { carer, client, currentProvinces, currentDistricts, currentCommunes, currentVillages, donors, agencies, schoolGrade, families, ratePoor, addressTypes } } = props
  ...
  return (
    <div className="containerClass">
      ...
      <CareInfo id="careInfo" data={{ carer, client, currentProvinces, currentDistricts, currentCommunes, currentVillages, families, addressTypes }} onChange={onChange} />
