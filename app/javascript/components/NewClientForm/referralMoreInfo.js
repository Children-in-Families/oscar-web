...
export default props => {
  const { onChange, setShowModal, data: { carer, client, currentProvinces, currentDistricts, currentCommunes, currentVillages, donors, agencies, schoolGrade, families } } = props
  ...
  return (
    <div className="containerClass">
      ...
      <CareInfo id="careInfo" setShowModal={setShowModal} data={{ carer, client, currentProvinces, currentDistricts, currentCommunes, currentVillages, families }} onChange={onChange} />
