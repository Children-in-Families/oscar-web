...
const Forms = (props) => {
  ...
  const handleTab = (goingToStep) => {
    ...
    if (
      ...
      if (step === 2) checkClientExist()(() => setStep(goingToStep));
  ...
  return (
    <div className="containerClass">
      ...
      <div className="tabHead">
        {tabs
          .slice(0, fieldsVisibility.show_legal_doc == true ? 5 : 4)
          .map((tab, index) => renderTab(tab, index))}
      </div>
