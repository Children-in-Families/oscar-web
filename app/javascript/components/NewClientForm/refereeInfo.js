...
export default props => {
  ...
  return (
    <div className="containerClass">
      ...
      <Address outside={referee.outside || false} onChange={onChange} data={{currentDistricts, currentCommunes, currentVillages, currentProvinces, addressTypes, objectKey: 'referee', objectData: referee}} />
    </div>
  )
}
