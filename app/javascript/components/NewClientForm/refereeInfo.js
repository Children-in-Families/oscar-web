...
export default props => {
  const { onChange, data: { client, birthProvinces, referralSourceCategory, referralSource, currentProvinces, district, commune, village} } = props
  ...
  return (
    <div className="container">
      ...
      <div className="row">
        <div className="col-xs-3">
          <SelectInput required label="Province" asGroup options={currentProvincesLists} onChange={onChange('referee', 'province_id')} />
        </div>
        <div className="col-xs-3">
