module AdvancedSearches
  class  RuleFields
    ...
    def text_type_list
      ['given_name', 'family_name', 'local_given_name', 'local_family_name', 'family', 'slug', 'referral_phone', 'house_number', 'street_number', 'village', 'commune', 'archive_district', 'school_name', 'school_grade']
    end
