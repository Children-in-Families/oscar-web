module AdvancedSearches
  class CustomDomainScoreFields
    ...
    def self.render(domain_type = 'client')
      ...
      date_of_assessments = [['date_of_custom_assessments', I18n.t('datagrid.columns.date_of_family_assessment')]].map{ |item| date_picker_options(item[0], item[1], domain_score_group) }
