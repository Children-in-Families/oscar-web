class ClientGrid
  ...
  scope do
    Client.includes(:village, :commune, :district, :referral_source, :received_by, :followed_up_by, :province, :assessments, :enter_ngos, :exit_ngos, :users, :custom_fields).order('clients.status, clients.given_name')
  end
