class PartnerGrid
  ...
  column(:name, html: true, header: -> {I18n.t('datagrid.columns.partners.name')}) do |object|
  ...
  column(:contact_person_email, header: -> {I18n.t('datagrid.columns.partners.contact_email')}) do |object|
