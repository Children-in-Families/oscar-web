module CustomFieldPropertiesHelper
  def custom_field_properties_edit_link(custom_field_property)
    if custom_field_editable?(@custom_field) && (client_custom_field? ? policy(@custom_formable).edit? : true)
  ...
  def custom_field_properties_destroy_link(custom_field_property)
    if custom_field_editable?(@custom_field) && (client_custom_field? ? policy(@custom_formable).destroy? : true)
  ...
  def custom_field_properties_new_link
    if custom_field_editable?(@custom_field) && (client_custom_field? ? policy(@custom_formable).new? : true)
