module ClientsHelper
  ...
  def country_scope_label_translation
    return '' if current_setting.try(:country_name) == 'nepal'
    if I18n.locale.to_s == 'en'
      country_name = current_setting.try(:country_name)
      case country_name
  ...
  def custom_id_translation(type)
    if I18n.locale != :km || current_setting.country_name != 'lesotho'
      if type == 'custom_id1'
        current_setting.custom_id1_latin.present? ? current_setting.custom_id1_latin : I18n.t("#{I18n.locale.to_s}.clients.other_detail.custom_id_number1")
      else
        current_setting.custom_id2_latin.present? ? current_setting.custom_id2_latin : I18n.t('other_detail.custom_id_number2')
      end
    else
      if type == 'custom_id1'
        current_setting.custom_id1_local.present? ? current_setting.custom_id1_local : I18n.t('other_detail.custom_id_number1')
      else
        current_setting.custom_id2_local.present? ? current_setting.custom_id2_local : I18n.t('other_detail.custom_id_number2')
      end
    end
  end
  ...
  def saved_search_column_visibility(field_key)
    client_default_columns ||= current_setting.client_default_columns
