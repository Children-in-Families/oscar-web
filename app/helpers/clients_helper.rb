module ClientsHelper
  ...
  def columns_visibility(column)
    label_column = {
      ...
      old_village:                   t('datagrid.columns.clients.old_village'),
      old_commune:                   t('datagrid.columns.clients.old_commune'),
  ...
  def default_columns_visibility(column)
    label_column = {
      ...
      old_village_: t('datagrid.columns.clients.old_village'),
      old_commune_: t('datagrid.columns.clients.old_commune'),
