module FamiliesHelper
  ...
  def columns_family_visibility(column)
    label_column = {
      ...
      old_commune:                              t('datagrid.columns.families.old_commune'),
      old_village:                              t('datagrid.columns.families.old_village'),
  ...
  def default_family_columns_visibility(column)
    label_column = {
      ...
      old_commune_:                              t('datagrid.columns.families.old_commune'),
      old_village_:                              t('datagrid.columns.families.old_village'),
