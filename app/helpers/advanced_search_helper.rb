module AdvancedSearchHelper
  ...
  def format_header(key)
    translations = {
      ...
      old_commune: I18n.t('advanced_search.fields.old_commune'),
      old_village: I18n.t('advanced_search.fields.old_village'),
  ...
  def family_header(key)
    translations = {
      ...
      old_commune:                              I18n.t('datagrid.columns.families.old_commune'),
      old_village:                              I18n.t('datagrid.columns.families.old_village'),
