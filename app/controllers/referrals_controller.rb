class ReferralsController < AdminController
  ...
  def referral_params
    params.require(:referral).permit(:referred_to, :referred_from, :name_of_referee, :referee_id, :referral_phone, :date_of_referral, :referral_reason, :client_name, :slug, :ngo_name, consent_form: [])
  end
end
