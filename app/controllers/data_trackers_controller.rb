class DataTrackersController < AdminController
  ...
  def exclude_item_type
    %w(AdvancedSearch AssessmentDomain CaseNoteDomainGroup CaseNote AgencyClient ClientQuantitativeCase ClientCustomField FamilyCustomField PartnerCustomField UserCustomField Location)
  end
