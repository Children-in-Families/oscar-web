class SettingsController < AdminController
  ...
  def client_default_columns
    ...
    sub_columns = %w(rejected_note_ exit_reasons_ exit_circumstance_ other_info_of_exit_ exit_note_ what3words_ main_school_contact_ rated_for_id_poor_ name_of_referee_
      case_start_date_ carer_names_  carer_address_ carer_phone_number_ support_amount_ support_note_ form_title_ family_preservation_ family_ partner_ case_note_date_ case_note_type_
      date_of_assessments_ all_csi_assessments_ manage_ changelog_)
