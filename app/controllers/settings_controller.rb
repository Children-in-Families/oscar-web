class SettingsController < AdminController
  ...
  def setting_params
    params.require(:setting).permit(:custom_assessment_frequency, :assessment_frequency, :max_custom_assessment,
                                    ...
                                    :cbdmat_one_off, :cbdmat_ongoing, :tracking_form_edit_limit, :tracking_form_edit_frequency,
                                    :disabled_add_service_received, :custom_field_limit, :custom_field_frequency, :test_client, :disabled_task_date_field, :disabled_progress_note_and_next_step,
