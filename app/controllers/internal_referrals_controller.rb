class InternalReferralsController < AdminController
  ...
  private
    ...
    def internal_referral_params
      params.require(:internal_referral).permit(:referral_date, :client_id, :user_id, :client_representing_problem, :emergency_note, :referral_reason, :referral_decision, attachments: [], program_stream_ids: [])
    end
end
