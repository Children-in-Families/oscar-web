module Api
  class CommunityAdvancedSearchesController < Api::ApplicationController
    def get_basic_field
    ...
    def get_custom_field
      ...
      advanced_filter_custom_field = AdvancedSearches::CustomFields.new(custom_form_ids, 'Community').render
      advanced_filter_custom_field << AdvancedSearches::HasThisFormFields.new(custom_form_ids, 'Community').render.first
