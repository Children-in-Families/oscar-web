module Api
  class ClientsController < Api::ApplicationController
    ...
    def assessments
      @assessments_count ||= Assessment.joins(:client).where("assessments.default = ? AND assessments.client_id IN (?)", params[:default], params[:client_ids].split('/')).count
    ...
    def fetch_assessments
      ...
      assessments = Assessment.joins(:client).where("assessments.default = ? AND assessments.client_id IN (?)", params[:default], params[:client_ids].split('/'))
