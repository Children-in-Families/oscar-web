class AssessmentsController < AdminController
  ...
  def edit
    ...
    redirect_to client_assessment_path(@client, @assessment), alert: 'You cannot edit assessment that is older than a week.' if !current_user.admin? && @assessment.over_a_week?
  end
