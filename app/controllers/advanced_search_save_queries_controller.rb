class AdvancedSearchSaveQueriesController < AdminController
  ...
  def create
    ...
    if @advanced_search.save
      redirect_to client_advanced_searches_path(search_params)
    else
  ...
  def advanced_search_params
    params.require(:advanced_search).permit(:title, :description, :queries, :enrollment_check, :tracking_check, :exit_form_check, :field_visible, :quantitative_check, :custom_forms, :program_streams)
  end
