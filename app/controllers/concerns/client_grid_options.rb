module ClientGridOptions
  ...
  def columns_visibility
    ...
    if params[:advanced_search_id]
      ...
      @client_columns = ClientColumnsVisibility.new(@client_grid,request.parameters.merge(advanced_search.field_visible).merge(column_form_builder: column_form_builder))
