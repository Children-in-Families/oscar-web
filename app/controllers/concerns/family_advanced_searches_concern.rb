module FamilyAdvancedSearchesConcern
  def advanced_search
    ...
    # clients              = AdvancedSearches::FamilyAdvancedSearch.new(basic_rules, Client.accessible_by(current_ability))
  ...
  def get_custom_form_fields
    @custom_form_fields = AdvancedSearches::CustomFields.new(custom_form_values, 'family').render
  end
