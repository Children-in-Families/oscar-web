module ClientConstants
  ...
  DUPLICATE_CHECKING_FIELDS = ['given_name', 'family_name', 'local_family_name', 'local_given_name', 'date_of_birth', 'current_province_id', 'district_id', 'commune_id', 'village_id', 'birth_province_id', 'gender']
