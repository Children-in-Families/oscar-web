class Dashboard
  ...
  def client_count
    if @user.admin?
      ...
      Client.able_managed_by(@user).count
  ...
  def male_count
    if @user.admin?
      ...
      Client.able_managed_by(@user).male.count
    elsif @user.any_case_manager?
  ...
  def female_count
    if @user.admin?
      ...
      Client.able_managed_by(@user).female.count
    elsif @user.any_case_manager?
