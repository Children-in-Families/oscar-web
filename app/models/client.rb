class Client < ActiveRecord::Base
  ...
  HOTLINE_FIELDS  = %w(nickname concern_is_outside concern_outside_address protection_concern_id necessity_id concern_province_id concern_district_id concern_commune_id concern_village_id concern_street concern_house concern_address concern_address_type concern_phone concern_phone_owner concern_email concern_email_owner concern_location concern_same_as_client location_description brief_note_summary)
