class Client < ActiveRecord::Base
  ...
  HEADER_COUNTS   = %w( case_note_date case_note_type exit_date accepted_date date_of_assessments custom_date_of_assessments program_streams programexitdate enrollmentdate).freeze
