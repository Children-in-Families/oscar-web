class Client < ActiveRecord::Base
  ...
  HOTLINE_FIELDS  = %w(nickname concern_is_outside concern_outside_address protection_concern_id necessity_id concern_province_id concern_district_id concern_commune_id concern_village_id concern_street concern_house concern_address concern_address_type concern_phone concern_phone_owner concern_email concern_email_owner concern_location concern_same_as_client location_description brief_note_summary phone_counselling_summary)
  ...
  HEADER_COUNTS   = %w( start_datetime case_note_date case_note_type exit_date accepted_date date_of_assessments date_of_custom_assessments program_streams programexitdate enrollmentdate quantitative-type type_of_service).freeze
