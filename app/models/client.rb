class Client < ActiveRecord::Base
  ...
  HEADER_COUNTS   = %w( case_note_date case_note_type exit_date accepted_date date_of_assessments date_of_custom_assessments program_streams exitprogramdate enrollmentdate quantitative-type).freeze
