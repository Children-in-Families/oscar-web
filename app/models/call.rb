class Call < ActiveRecord::Base
  FIELDS = %w( phone_call_id call_type start_datetime end_datetime start_time end_time information_provided answered_call called_before requested_update not_a_phone_call)
  TYPES  = [
