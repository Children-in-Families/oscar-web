class CaseNoteSerializer < ActiveModel::Serializer
  attributes :attendee, :meeting_date, :interaction_type, :assessment_id, :id, :case_note_domain_groups, :selected_domain_group_ids, :attachments, :created_at, :updated_at
