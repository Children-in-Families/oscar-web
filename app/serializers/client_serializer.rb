class ClientSerializer < ActiveModel::Serializer
  ...
  def list_program_stream(program_stream)
    ...
    program_stream.as_json(only: [:id, :name, :description, :quantity, :tracking_required, :exit_program, :enrollment, :program_exclusive, :mutual_dependence]).merge(domain: domains, enrollments: formatted_enrollments, tracking_fields: tracking_fields)
  end
end
