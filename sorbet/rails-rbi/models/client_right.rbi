# This is an autogenerated file for dynamic methods in ClientRight
# Please rerun rake rails_rbi:models to regenerate.
# typed: strong

class ClientRight::ActiveRecord_Relation < ActiveRecord::Relation
  include ClientRight::ModelRelationShared
  extend T::Generic
  Elem = type_member(fixed: ClientRight)
end

class ClientRight::ActiveRecord_Associations_CollectionProxy < ActiveRecord::Associations::CollectionProxy
  include ClientRight::ModelRelationShared
  extend T::Generic
  Elem = type_member(fixed: ClientRight)
end
...
class ClientRight < ActiveRecord::Base
  extend T::Sig
  extend T::Generic
  extend ClientRight::ModelRelationShared
  include ClientRight::InstanceMethods
  Elem = type_template(fixed: ClientRight)
end

module ClientRight::InstanceMethods
  extend T::Sig
...
module ClientRight::ModelRelationShared
  extend T::Sig

  sig { returns(ClientRight::ActiveRecord_Relation) }
  def all(); end

  sig { params(block: T.nilable(T.proc.void)).returns(ClientRight::ActiveRecord_Relation) }
  def unscoped(&block); end

  sig { params(args: T.untyped, block: T.nilable(T.proc.void)).returns(ClientRight::ActiveRecord_Relation) }
