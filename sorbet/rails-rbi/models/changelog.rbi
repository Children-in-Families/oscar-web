...
class Changelog::ActiveRecord_Relation < ActiveRecord::Relation
  include Changelog::ModelRelationShared
  extend T::Generic
...
class Changelog < ActiveRecord::Base
  extend T::Sig
  extend T::Generic
  extend Changelog::ModelRelationShared
  include Changelog::InstanceMethods
  Elem = type_template(fixed: Changelog)
end

module Changelog::InstanceMethods
  extend T::Sig

  sig { returns(T.nilable(String)) }
  def change_version(); end

  sig { params(value: T.nilable(String)).void }
  def change_version=(value); end

  sig { params(args: T.untyped).returns(T::Boolean) }
  def change_version?(*args); end
...
class Changelog
  ...
  sig { returns(::ChangelogType::ActiveRecord_Associations_CollectionProxy) }
  def changelog_types(); end

  sig { params(value: T.any(T::Array[::ChangelogType], ::ChangelogType::ActiveRecord_Associations_CollectionProxy)).void }
  def changelog_types=(value); end
...
module Changelog::ModelRelationShared
  extend T::Sig
