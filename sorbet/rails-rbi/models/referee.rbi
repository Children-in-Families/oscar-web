# This is an autogenerated file for dynamic methods in Referee
# Please rerun rake rails_rbi:models to regenerate.
# typed: strong

class Referee::ActiveRecord_Relation < ActiveRecord::Relation
  include Referee::ModelRelationShared
  extend T::Generic
  Elem = type_member(fixed: Referee)
end

class Referee::ActiveRecord_Associations_CollectionProxy < ActiveRecord::Associations::CollectionProxy
  include Referee::ModelRelationShared
  extend T::Generic
  Elem = type_member(fixed: Referee)
end
...
class Referee < ActiveRecord::Base
  extend T::Sig
  extend T::Generic
  extend Referee::ModelRelationShared
  include Referee::InstanceMethods
  Elem = type_template(fixed: Referee)
end

module Referee::InstanceMethods
  extend T::Sig
...
module Referee::ModelRelationShared
  extend T::Sig

  sig { returns(Referee::ActiveRecord_Relation) }
  def all(); end

  sig { params(block: T.nilable(T.proc.void)).returns(Referee::ActiveRecord_Relation) }
  def unscoped(&block); end

  sig { params(args: T.untyped).returns(Referee::ActiveRecord_Relation) }
  def none_anonymouse(*args); end

  sig { params(args: T.untyped, block: T.nilable(T.proc.void)).returns(Referee::ActiveRecord_Relation) }
