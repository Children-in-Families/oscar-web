# This is an autogenerated file for dynamic methods in ServiceType
# Please rerun rake rails_rbi:models to regenerate.
# typed: strong

class ServiceType::ActiveRecord_Relation < ActiveRecord::Relation
  include ServiceType::ModelRelationShared
  extend T::Generic
  Elem = type_member(fixed: ServiceType)
end

class ServiceType::ActiveRecord_Associations_CollectionProxy < ActiveRecord::Associations::CollectionProxy
  include ServiceType::ModelRelationShared
  extend T::Generic
  Elem = type_member(fixed: ServiceType)
end
...
class ServiceType < ActiveRecord::Base
  extend T::Sig
  extend T::Generic
  extend ServiceType::ModelRelationShared
  include ServiceType::InstanceMethods
  Elem = type_template(fixed: ServiceType)
end

module ServiceType::InstanceMethods
  extend T::Sig
...
module ServiceType::ModelRelationShared
  extend T::Sig

  sig { returns(ServiceType::ActiveRecord_Relation) }
  def all(); end

  sig { params(block: T.nilable(T.proc.void)).returns(ServiceType::ActiveRecord_Relation) }
  def unscoped(&block); end

  sig { params(args: T.untyped, block: T.nilable(T.proc.void)).returns(ServiceType::ActiveRecord_Relation) }
