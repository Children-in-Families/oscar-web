# This is an autogenerated file for dynamic methods in Interviewee
# Please rerun rake rails_rbi:models to regenerate.
# typed: strong

class Interviewee::ActiveRecord_Relation < ActiveRecord::Relation
  include Interviewee::ModelRelationShared
  extend T::Generic
  Elem = type_member(fixed: Interviewee)
end

class Interviewee::ActiveRecord_Associations_CollectionProxy < ActiveRecord::Associations::CollectionProxy
  include Interviewee::ModelRelationShared
  extend T::Generic
  Elem = type_member(fixed: Interviewee)
end
...
class Interviewee < ActiveRecord::Base
  extend T::Sig
  extend T::Generic
  extend Interviewee::ModelRelationShared
  include Interviewee::InstanceMethods
  Elem = type_template(fixed: Interviewee)
end

module Interviewee::InstanceMethods
  extend T::Sig
...
module Interviewee::ModelRelationShared
  extend T::Sig

  sig { returns(Interviewee::ActiveRecord_Relation) }
  def all(); end

  sig { params(block: T.nilable(T.proc.void)).returns(Interviewee::ActiveRecord_Relation) }
  def unscoped(&block); end

  sig { params(args: T.untyped, block: T.nilable(T.proc.void)).returns(Interviewee::ActiveRecord_Relation) }
