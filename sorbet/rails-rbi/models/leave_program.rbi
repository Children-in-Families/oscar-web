# This is an autogenerated file for dynamic methods in LeaveProgram
# Please rerun rake rails_rbi:models to regenerate.
# typed: strong

class LeaveProgram::ActiveRecord_Relation < ActiveRecord::Relation
  include LeaveProgram::ModelRelationShared
  extend T::Generic
  Elem = type_member(fixed: LeaveProgram)
end

class LeaveProgram::ActiveRecord_Associations_CollectionProxy < ActiveRecord::Associations::CollectionProxy
  include LeaveProgram::ModelRelationShared
  extend T::Generic
  Elem = type_member(fixed: LeaveProgram)
end
...
class LeaveProgram < ActiveRecord::Base
  extend T::Sig
  extend T::Generic
  extend LeaveProgram::ModelRelationShared
  include LeaveProgram::InstanceMethods
  Elem = type_template(fixed: LeaveProgram)
end

module LeaveProgram::InstanceMethods
  extend T::Sig
...
module LeaveProgram::ModelRelationShared
  extend T::Sig

  sig { returns(LeaveProgram::ActiveRecord_Relation) }
  def all(); end

  sig { params(block: T.nilable(T.proc.void)).returns(LeaveProgram::ActiveRecord_Relation) }
  def unscoped(&block); end

  sig { params(args: T.untyped).returns(LeaveProgram::ActiveRecord_Relation) }
  ...
  sig { params(args: T.untyped, block: T.nilable(T.proc.void)).returns(LeaveProgram::ActiveRecord_Relation) }
