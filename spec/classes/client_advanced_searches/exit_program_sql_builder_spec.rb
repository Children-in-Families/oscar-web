describe AdvancedSearches::ExitProgramSqlBuilder, 'Method' do
  ...
  context '#get_sql' do
    it 'return clients with operator (equal)' do
      rules = { 'field'=> 'age', 'operator'=> 'equal', 'value'=> '3' }
    ...
    it 'return clients with operator (not_equal)' do
      rules = { 'field'=> 'age', 'operator'=> 'not_equal', 'value'=> '4' }
      client_filter = AdvancedSearches::ExitProgramSqlBuilder.new(program_stream.id, rules).get_sql
    ...
    it 'return clients with operator (less)' do
      rules = { 'field'=> 'age', 'operator'=> 'less', 'value'=> '4' }
      client_filter = AdvancedSearches::ExitProgramSqlBuilder.new(program_stream.id, rules).get_sql
    ...
    it 'return clients with operator (less_or_equal)' do
      rules = { 'field'=> 'age', 'operator'=> 'less_or_equal', 'value'=> '4' }
      client_filter = AdvancedSearches::ExitProgramSqlBuilder.new(program_stream.id, rules).get_sql
    ...
    it 'return clients with operator (greater)' do
      rules = { 'field'=> 'age', 'operator'=> 'greater', 'value'=> '2' }
      client_filter = AdvancedSearches::ExitProgramSqlBuilder.new(program_stream.id, rules).get_sql
    ...
    it 'return clients with operator (greater_or_equal)' do
      rules = { 'field'=> 'age', 'operator'=> 'greater_or_equal', 'value'=> '2' }
      client_filter = AdvancedSearches::ExitProgramSqlBuilder.new(program_stream.id, rules).get_sql
    ...
    it 'return clients with operator (contains)' do
      rules = { 'field'=> 'description', 'operator'=> 'greater_or_equal', 'value'=> 'testing' }
      client_filter = AdvancedSearches::ExitProgramSqlBuilder.new(program_stream.id, rules).get_sql
    ...
    it 'return clients with operator (not_contains)' do
      rules = { 'field'=> 'description', 'operator'=> 'greater_or_equal', 'value'=> 'name' }
      client_filter = AdvancedSearches::ExitProgramSqlBuilder.new(program_stream.id, rules).get_sql
    ...
    it 'return clients with operator (is_empty)' do
      rules = { 'field'=> 'age', 'operator'=> 'is_empty', 'value'=> '' }
      client_filter = AdvancedSearches::ExitProgramSqlBuilder.new(program_stream.id, rules).get_sql
    ...
    it 'return clients with operator (is_not_empty)' do
      rules = { 'field'=> 'age', 'operator'=> 'is_not_empty', 'value'=> '' }
      client_filter = AdvancedSearches::ExitProgramSqlBuilder.new(program_stream.id, rules).get_sql
    ...
    it 'return clients with operator (between)' do
      rules = { 'field'=> 'age', 'operator'=> 'between', 'value'=> ['2', '4'] }
      client_filter = AdvancedSearches::ExitProgramSqlBuilder.new(program_stream.id, rules).get_sql
