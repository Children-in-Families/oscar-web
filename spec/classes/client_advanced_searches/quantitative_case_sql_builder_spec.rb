describe AdvancedSearches::QuantitativeCaseSqlBuilder, 'Method' do
  ...
  context '#get_sql' do
    it 'return clients with operator (equal)' do
      rules = { 'field'=> "quantitative_#{quantitative_type.id}", 'operator'=> 'equal', 'value'=> quantitative_case.id }
    ...
    it 'return clients with operator (not_equal)' do
      rules = { 'field'=> "quantitative_#{quantitative_type.id}", 'operator'=> 'not_equal', 'value'=> quantitative_case.id }
      client_filter = AdvancedSearches::QuantitativeCaseSqlBuilder.new(Client.all, rules).get_sql
    ...
    it 'return clients with operator (is_empty)' do
      rules = { 'field'=> "quantitative_#{quantitative_type.id}", 'operator'=> 'is_empty', 'value'=> '' }
      client_filter = AdvancedSearches::QuantitativeCaseSqlBuilder.new(Client.all, rules).get_sql
    ...
    it 'return clients with operator (is_not_empty)' do
      rules = { 'field'=> "quantitative_#{quantitative_type.id}", 'operator'=> 'is_not_empty', 'value'=> '' }
      client_filter = AdvancedSearches::QuantitativeCaseSqlBuilder.new(Client.all, rules).get_sql
