...
describe AssessmentDomain, 'class method' do
  ...
  context '.any_problems?' do
    it { expect(assessment.assessment_domains.any_problems?).to be_truthy }
    it { expect(other_assessment.assessment_domains.any_problems?).to be_falsey }
  end
  ...
  context '.warning_or_danger' do
    it 'should be return warning or danger assessment domain' do
      expect(assessment.assessment_domains.warning_or_danger).to eq [critical_problem]
    end

    it { expect(other_assessment.assessment_domains.warning_or_danger).to be_empty }
  end
end
