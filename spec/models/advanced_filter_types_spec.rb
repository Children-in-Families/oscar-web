# describe FilterTypes, 'Method' do
#   context '#text_options' do
#     text_options = AdvancedSearches::FilterTypes.text_options('given_name', 'Name')
#
...
#     number_options = AdvancedSearches::FilterTypes.number_options('code', 'Code')
#
#     it 'return configuration object with id' do
...
#     drop_list_options = AdvancedSearches::FilterTypes.drop_list_options('gender', 'Gender', {male: 'Male', female: 'Female'})
#
#     it 'return configuration object with id' do
...
#     date_picker_options = AdvancedSearches::FilterTypes.date_picker_options('date_of_birth', 'Date of Birth')
#
#     it 'return configuration object with id' do
