describe ClientEnrollmentTrackingHistory, 'class methods' do
  ...
  xcontext 'initial(client_enrollment_tracking)' do
  ...
  context 'format_property(attributes)' do
    ...
    let!(:client_enrollment_tracking){ create(:client_enrollment_tracking, :client_with_history, tracking: tracking, properties: {"Checkbox Group"=>["Option 1"], "Radio.Group"=>"Option 1", "Select"=>["Option 1"]}.to_json) }
