describe "Assessment" do
  ...
  context 'Create' do
    ...
    scenario 'valid', js: true do
      ...
      expect(page.find('.domain-score')).to have_content('3')
    end
  end
  ...
  context 'Index' do
    ...
    let!(:last_assessment){ create(:assessment, created_at: Time.now - 6.month, client: other_client) }
    ...
    xscenario 'no new assessment' do
