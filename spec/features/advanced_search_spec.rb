  ...
  feature 'List' do
    ...
    feature 'Search Settings List', js: true do
      scenario 'my saved search' do
        ...
        expect(page).to have_content(date_format(advanced_search_1.created_at))
        ...
        expect(page).not_to have_content(date_format(advanced_search_6.created_at))
      end
      ...
      scenario 'saved search of other people within org' do
        ...
        expect(page).to have_content(date_format(advanced_search_6.created_at))
