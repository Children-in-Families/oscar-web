 ...
 */
$.fn.queryBuilder.define('sql-support', function(options) {
...
$.fn.queryBuilder.defaults({
    ...
    sqlOperators: {
        ...
        begins_with: { op: 'LIKE(?)'},
        not_begins_with: { op: 'NOT LIKE(?)'},
        contains: { op: 'includes ?', mod: '{0}' },
        not_contains: { op: 'excludes ?', mod: '{0}'},
        ends_with: { op: 'LIKE(?)'},
        not_ends_with: { op: 'NOT LIKE(?)'},
...
$.fn.queryBuilder.extend(/** @lends module:plugins.SqlSupport.prototype */ {
    /**
