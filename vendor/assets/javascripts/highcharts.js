...
(function (L, a) {
  ...
  (function (a) {
    ...
    a.error = function (h, f) {
      h = a.isNumber(h)
        ? "Highcharts error #" + h + ": www.highcharts.com/errors/" + h
        : h;
      if (f) throw Error(h);
    ...
    a.Fx.prototype = {
      dSetter: function () {
        ...
        if (1 === v) p = this.toD;
          ...
          for (; l--; )
            (u = parseFloat(a[l])),
              (p[l] = isNaN(u) ? a[l] : v * parseFloat(f[l] - u) + u);
        else p = f;
      ...
      update: function () {
        ...
        if (this[f + "Setter"]) this[f + "Setter"]();
          ...
          a.attr
            ? a.element && a.attr(f, p, null, !0)
            : (a.style[f] = p + this.unit);
        v && v.call(a, p, this);
      },
      run: function (a, f, p) {
        var h = this,
      ...
      step: function (a) {
        ...
        if (h.attr && !h.element) h = !1;
          ...
          (this.pos = v.easing((f - this.startTime) / u)),
      ...
      initPath: function (h, f, p) {
        ...
        function u(a, e) {
          for (var c = (m - a.length) / t; 0 < c && c--; )
            (b = a.slice().splice(a.length / F - t, t * F)),
              (b[0] = e[m - t - c * t]),
              y && ((b[t - 6] = b[t - 2]), (b[t - 5] = b[t - 1])),
              [].splice.apply(a, [a.length / F, 0].concat(b)),
              z && c--;
        }
        f = f || "";
        var d,
    ...
    a.attr = function (h, f, p) {
      ...
      if (a.isString(f))
        a.defined(p)
          ? h.setAttribute(f, p)
          : h && h.getAttribute && (l = h.getAttribute(f));
    ...
    a.getTZOffset = function (h) {
      ...
      return (
        6e4 *
        ((f.hcGetTimezoneOffset && f.hcGetTimezoneOffset(h)) ||
          f.hcTimezoneOffset ||
          0)
      );
    };
    ...
    a.numberFormat = function (h, f, p, v) {
      h = +h || 0;
      f = +f;
      ...
      f &&
        ((v = Math.abs(n - d + Math.pow(10, -Math.max(f, u) - 1))),
        (h += p + v.toFixed(f).slice(2)));
      return h;
    };
    ...
    a.getStyle = function (h, f) {
      return "width" === f
        ? Math.min(h.offsetWidth, h.scrollWidth) -
            a.getStyle(h, "padding-left") -
            a.getStyle(h, "padding-right")
        : "height" === f
        ? Math.min(h.offsetHeight, h.scrollHeight) -
          a.getStyle(h, "padding-top") -
          a.getStyle(h, "padding-bottom")
        : (h = I.getComputedStyle(h, void 0)) && a.pInt(h.getPropertyValue(f));
    };
    ...
    a.addEvent = function (h, f, p) {
      ...
      h.addEventListener
        ? h.addEventListener(f, p, !1)
        : h.attachEvent &&
          (h.hcEventsIE || (h.hcEventsIE = {}),
          (h.hcEventsIE[p.toString()] = v),
          h.attachEvent("on" + f, v));
      l[f] || (l[f] = []);
      l[f].push(p);
      return function () {
        a.removeEvent(h, f, p);
    ...
    a.removeEvent = function (h, f, p) {
      function v(a, c) {
        h.removeEventListener
          ? h.removeEventListener(a, c, !1)
          : h.attachEvent &&
            ((c = h.hcEventsIE[c.toString()]), h.detachEvent("on" + a, c));
      }
      function l() {
        var a, c;
        if (h.nodeName)
          for (c in (f ? ((a = {}), (a[f] = !0)) : (a = d), a))
            if (d[c]) for (a = d[c].length; a--; ) v(c, d[c][a]);
      }
      var u,
        d = h.hcEvents,
        c;
    ...
    a.fireEvent = function (h, f, p, v) {
      ...
      var u, d;
      p = p || {};
      if (G.createEvent && (h.dispatchEvent || h.fireEvent))
        (l = G.createEvent("Events")),
          l.initEvent(f, !0, !0),
          a.extend(l, p),
          h.dispatchEvent ? h.dispatchEvent(l) : h.fireEvent(f, l);
      else if (l)
        for (
          l = l[f] || [],
            u = l.length,
    ...
    a.animate = function (h, f, p) {
      ...
      a.isObject(p) ||
        ((v = arguments),
        (p = { duration: v[2], easing: v[3], complete: v[4] }));
      ...
      for (c in f)
        a.stop(h, c),
          ...
          (u = null),
          "d" === c
            ? ((d.paths = d.initPath(h, h.d, f.d)),
              (d.toD = f.d),
              (v = 0),
              (u = 1))
            : h.attr
            ? (v = h.attr(c))
            : ((v = parseFloat(a.getStyle(h, c)) || 0),
              "opacity" !== c && (l = "px")),
          u || (u = f[c]),
          u.match && u.match("px") && (u = u.replace(/px/g, "")),
          d.run(v, u, l);
    };
    ...
    I.jQuery &&
      (I.jQuery.fn.highcharts = function () {
        ...
        if (this[0])
          return h[0]
            ? (new a[a.isString(h[0]) ? h.shift() : "Chart"](
                this[0],
                h[0],
                h[1]
              ),
    ...
    G &&
      ...
      (a.getStyle = function (h, f) {
        ...
        if (p)
          return (
            (h.style.zoom = 1), Math.max(h[p] - 2 * a.getStyle(h, "padding"), 0)
          );
        h =
          h.currentStyle[
            f.replace(/\-(\w)/g, function (a, l) {
              return l.toUpperCase();
            })
          ];
        "filter" === f &&
          (h = h.replace(/alpha\(opacity=([0-9]+)\)/, function (a, l) {
            return l / 100;
          }));
        return "" === h ? 1 : a.pInt(h);
      });
  ...
  (function (a) {
    ...
    a.Color.prototype = {
      ...
      init: function (f) {
        var p, h, l, u;
        if ((this.input = f = this.names[f] || f) && f.stops)
          this.stops = G(f.stops, function (d) {
            return new a.Color(d[1]);
          });
        else
          for (l = this.parsers.length; l-- && !h; )
  ...
  (function (a) {
    ...
    D.prototype = {
      ...
      colorGradient: function (E, H, g) {
        ...
        E.linearGradient
          ? (b = "linearGradient")
          : E.radialGradient && (b = "radialGradient");
        if (b) {
          B = E[b];
          m = e.gradients;
          q = E.stops;
          ...
          m[t]
            ? (n = m[t].attr("id"))
            : ((B.id = n = a.uniqueKey()),
              (m[t] = w = e.createElement(b).attr(B).add(e.defs)),
              (w.radAttr = r),
              (w.stops = []),
              y(q, function (E) {
                0 === E[1].indexOf("rgba")
                  ? ((c = a.color(E[1])), (d = c.get("rgb")), (x = c.get("a")))
                  : ((d = E[1]), (x = 1));
                E = e
                  .createElement("stop")
                  .attr({ offset: E[0], "stop-color": d, "stop-opacity": x })
                  .add(w);
                w.stops.push(E);
              }));
          A = "url(" + e.url + "#" + n + ")";
      ...
      applyTextOutline: function (a) {
        ...
        -1 !== a.indexOf("contrast") &&
          (a = a.replace(/contrast/g, this.renderer.getContrast(E.style.fill)));
        this.fakeTS = !0;
        ...
        (k = a[0]) &&
          "none" !== k &&
          ((k = k.replace(/(^[\d\.]+)(.*?)$/g, function (a, E, H) {
            return 2 * E + H;
          })),
          y(g, function (a) {
      ...
      attr: function (a, H, e, k) {
        ...
        "string" === typeof a &&
          ...
          ((E = a), (a = {}), (a[E] = H));
        if ("string" === typeof a)
          B = (this[a + "Getter"] || this._defaultGetter).call(this, a, b);
        else {
          for (E in a)
            (H = a[E]),
              (r = !1),
              ...
              this.symbolName &&
                ...
                (c || (this.symbolAttr(a), (c = !0)), (r = !0)),
              !this.rotation ||
                ("x" !== E && "y" !== E) ||
                (this.doTransform = !0),
              r ||
                ((r = this[E + "Setter"] || this._defaultSetter),
                r.call(this, H, E, b),
                this.shadows &&
                  /^(width|height|visibility|x|y|d|transform|cx|cy|r)$/.test(
                    E
                  ) &&
                  this.updateShadows(E, H, r));
          this.doTransform && (this.updateTransform(), (this.doTransform = !1));
        }
        e && e();
        return B;
      },
      updateShadows: function (a, H, g) {
        for (var E = this.shadows, e = E.length; e--; )
          g.call(
            E[e],
            "height" === a
              ? Math.max(H - (E[e].cutHeight || 0), 0)
              : "d" === a
              ? this.d
              : H,
            a,
      ...
      removeClass: function (a) {
        h(
          this.element,
          "class",
          (h(this.element, "class") || "").replace(a, "")
        );
        return this;
      },
      ...
      crisp: function (a, g) {
        ...
        for (E in a) this[E] !== a[E] && (this[E] = H[E] = a[E]);
        return H;
      },
      css: function (a) {
        var g = this.styles,
        ...
        if (b) {
          ...
          this.added &&
            (b && this.renderer.buildText(this),
          ...
          ? ((e.ontouchstart = function (a) {
            ...
            (e.onclick = function (a) {
              (-1 === R.navigator.userAgent.indexOf("Android") ||
                1100 < Date.now() - (E.touchEventFired || 0)) &&
                g.call(e, a);
            }))
          : (e["on" + a] = g);
        return this;
      ...
      align: function (a, g, e) {
        ...
        if (a) {
          if (
            ((this.alignOptions = a), (this.alignByTranslate = g), !e || x(e))
          )
      ...
      getBBox: function (a, g) {
        ...
        void 0 !== r &&
          ((x = r.toString()),
          -1 === x.indexOf("\x3c") && (x = x.replace(/[0-9]/g, "0")),
          (x += [
            "",
            g || 0,
            B,
            b.style.width,
            b.style["text-overflow"],
          ].join()));
        x && !a && (E = w[x]);
        if (!E) {
        ...
        if (!a) this.destroyShadows();
          ...
          for (b = 1; b <= B; b++)
            (k = H.cloneNode(0)),
              ...
              e &&
                (h(k, "height", Math.max(h(k, "height") - c, 0)),
                (k.cutHeight = c)),
              g ? g.element.appendChild(k) : H.parentNode.insertBefore(k, H),
              E.push(k);
          this.shadows = E;
        }
        return this;
      ...
      titleSetter: function (a) {
        ...
        g ||
          ((g = n.createElementNS(this.SVG_NS, "title")),
      ...
      zIndexSetter: function (a, g) {
        ...
        var r;
        u(a) &&
          ((B.zIndex = a), (a = +a), this[g] === a && (c = !1), (this[g] = a));
        if (c) {
          (a = this.zIndex) && k && (k.handleZ = !0);
          g = b.childNodes;
          for (r = 0; r < g.length && !H; r++)
            (k = g[r]),
              (c = k.zIndex),
              k !== B &&
                (J(c) > a ||
    ...
    D.prototype["stroke-widthSetter"] = D.prototype.strokeSetter = function (
      a,
      g,
      e
    ) {
      ...
      this.stroke && this["stroke-width"]
        ? (D.prototype.fillSetter.call(this, this.stroke, "stroke", e),
    ...
    C.prototype = {
      ...
      init: function (a, g, e, k, b, c) {
        ...
        this.alignedObjects = [];
        this.url =
          (F || A) && n.getElementsByTagName("base").length
            ? R.location.href
                .replace(/#.*?$/, "")
                .replace(/([\('\)])/g, "\\$1")
                .replace(/ /g, "%20")
        ...
        this.createElement("desc")
          .add()
          .element.appendChild(
            n.createTextNode("Created with Highcharts 5.0.6")
          );
        ...
        F &&
          ...
          g(),
          (this.unSubPixelFix = G(R, "resize", g)));
      },
      getStyle: function (a) {
        return (this.style = t(
          {
            fontFamily:
              '"Lucida Grande", "Khmer OS Battambang", "Lucida Sans Unicode", Arial, Helvetica, sans-serif',
            fontSize: "12px",
          },
          a
        ));
      ...
      buildText: function (a) {
        for (
          var g = a.element,
            ...
            z = t && t.lineHeight,
            l = t && t.textOutline,
            F = t && "ellipsis" === t.textOverflow,
            f = m.length,
            u = A && !a.added && this.box,
            p = function (a) {
              var k;
              k = /(px|em)$/.test(a && a.style.fontSize)
                ? a.style.fontSize
                : (t && t.fontSize) || e.style.fontSize || 12;
              return z
                ? J(z)
                : e.fontMetrics(k, a.getAttribute("style") ? a : g).h;
            };
          f--;
        ...
        r || l || F || A || -1 !== c.indexOf(" ")
          ? ((w = /<.*class="([^"]+)".*>/),
              ...
              y(r, function (b) {
                if ("" !== b || 1 === r.length) {
                  ...
                  if (" " !== b) {
                    ...
                    !H &&
                      c &&
                      (!B && k && v(l, { display: "block" }), h(l, "dy", p(l)));
                    if (A) {
                      m = b.replace(/([^\^])-/g, "$1- ").split(" ");
                      z = "nowrap" === t.whiteSpace;
                      for (
                        var K = 1 < r.length || c || (1 < m.length && !z),
                          u,
                          y,
                          J = [],
                          M = p(l),
                        ...
                        (a.rotation = 0),
                          ...
                          F && x
                            ? ((N /= 2),
                              "" === O || (!u && 0.5 > N)
                                ...
                                : ((O = b.substring(
                                    0,
                                    O.length + (u ? -1 : 1) * Math.ceil(N)
                                  )),
                                  (m = [O + (3 < A ? "\u2026" : "")]),
                                  l.removeChild(l.firstChild)))
                            : u && 1 !== m.length
                            ? (l.removeChild(l.firstChild), J.unshift(m.pop()))
                            : ((m = J),
                              (J = []),
                              m.length &&
                                !z &&
                                ((l = n.createElementNS(S, "tspan")),
                                h(l, { dy: M, x: d }),
                                f && h(l, "style", f),
                                g.appendChild(l)),
                              y > A && (A = y)),
                          m.length &&
                            l.appendChild(
                              n.createTextNode(m.join(" ").replace(/- /g, "-"))
                            );
                      a.rotation = P;
                    }
                    H++;
            ...
            u && u.removeChild(g),
            l && a.applyTextOutline && a.applyTextOutline(l))
          : g.appendChild(
              n.createTextNode(
      ...
      rect: function (a, g, e, b, k, c) {
        ...
        a = r(a)
          ...
          : void 0 === a
          ? {}
          : { x: a, y: g, width: Math.max(e, 0), height: Math.max(b, 0) };
      ...
      image: function (a, g, e, b, k) {
        ...
        c.element.setAttributeNS
          ? c.element.setAttributeNS("http://www.w3.org/1999/xlink", "href", a)
          : c.element.setAttribute("hc-svg-href", a);
        return c;
      },
      symbol: function (a, g, e, b, k, c) {
        ...
        H
          ? ((r = this.path(m)),
            r.attr("fill", "none"),
            t(r, { symbolName: a, x: g, y: e, width: b, height: k }),
            c && t(r, c))
          : w.test(a) &&
            ((q = a.match(w)[1]),
            (r = this.image(q)),
            (r.imgwidth = K(M[q] && M[q].width, c && c.width)),
            (r.imgheight = K(M[q] && M[q].height, c && c.height)),
            (x = function () {
              ...
              r[a + "Setter"] = function (a, g) {
                ...
                u(b) &&
                  ...
                  this.alignByTranslate ||
                    ((e[k] = ((this[g] || 0) - b) / 2), this.attr(e)));
              };
            }),
            u(g) && r.attr({ x: g, y: e }),
            (r.isImg = !0),
            u(r.imgwidth) && u(r.imgheight)
              ? x()
              : (r.attr({ width: 0, height: 0 }),
                l("img", {
                  onload: function () {
                    var a = f[B.chartIndex];
                    0 === this.width &&
                      (v(this, { position: "absolute", top: "-999em" }),
      ...
      symbols: {
        ...
        callout: function (a, g, e, b, k) {
          ...
          r && r > e
            ...
            : r && 0 > r
            ? k > g + B && k < g + b - B
              ? m.splice(33, 3, "L", a, k + 6, a - 6, k, a, k - 6, a, g + c)
              : m.splice(33, 3, "L", a, b / 2, r, k, a, b / 2, a, g + c)
            : k && k > b && r > a + B && r < a + e - B
            ? m.splice(
                23,
                3,
            ...
            : k &&
              ...
              r > a + B &&
              r < a + e - B &&
              m.splice(3, 3, "L", r - 6, g, r, g - 6, r + 6, g, e - c, g);
          return m;
        },
      },
      clipRect: function (g, e, b, k) {
        var c = a.uniqueKey(),
          B = this.createElement("clipPath").attr({ id: c }).add(this.defs);
      ...
      fontMetrics: function (a, g) {
        ...
        a = /px/.test(a)
          ? J(a)
          : /em/.test(a)
          ? parseFloat(a) * (g ? this.fontMetrics(null, g.parentNode).f : 16)
          : 12;
      ...
      label: function (a, g, e, b, c, B, r, m, w) {
        ...
        R = function () {
          var a = d.element.style,
            g = {};
          n =
            (void 0 === F || void 0 === f || J) && u(d.textStr) && d.getBBox();
          x.width = (F || n.width || 0) + 2 * A + z;
          x.height = (f || n.height || 0) + 2 * A;
          S = A + q.fontMetrics(a && a.fontSize, d).b;
          v &&
            (H ||
              ((x.box = H = q.symbols[b] || E ? q.symbol(b) : q.rect()),
              H.addClass(
                ("button" === w ? "" : "highcharts-label-box") +
                  (w ? " highcharts-" + w + "-box" : "")
              ),
              H.add(x),
              (a = P()),
              (g.x = a),
              (g.y = (m ? -S : 0) + a)),
            (g.width = Math.round(x.width)),
            (g.height = Math.round(x.height)),
            H.attr(t(g, h)),
            (h = {}));
        };
        O = function () {
          ...
          u(F) &&
            n &&
            ("center" === J || "right" === J) &&
            (a += { center: 0.5, right: 1 }[J] * (F - n.width));
          if (a !== d.x || g !== d.y)
            d.attr("x", a), void 0 !== g && d.attr("y", g);
          d.x = a;
          d.y = g;
        };
        Q = function (a, g) {
  ...
  (function (a) {
    ...
    f(a.SVGElement.prototype, {
        ...
        if (this.added) {
          ...
          if ("SPAN" === c.tagName) {
            var x = this.rotation,
              A = u(this.textWidth),
              k = r && r.whiteSpace,
              w = [x, n, c.innerHTML, this.textWidth, this.textAlign].join();
            w !== this.cTT &&
              ((r = a.fontMetrics(c.style.fontSize).b),
              I(x) && this.setSpanRotation(x, e, r),
              G(c, { width: "", whiteSpace: k || "nowrap" }),
              c.offsetWidth > A &&
      ...
      setSpanRotation: function (a, d, m) {
        ...
        b[q + (p ? "Origin" : "-origin")] = b.transformOrigin =
          100 * d + "% " + m + "px";
        G(this.element, b);
      },
    ...
    a.svg ||
      ((C = {
        ...
        init: function (a, b) {
          ...
          b &&
            ((e = k || "span" === b || "img" === b ? e.join("") : a.prepVML(e)),
            (this.element = G(e)));
          this.renderer = a;
        },
        add: function (a) {
        ...
        getSpanCorrection: function (a, b, c, q, k) {
          ...
          k &&
            ...
            q && (this.yCorr -= x * c * (0 > r ? -1 : 1)),
            I(this.element, { textAlign: k }));
        },
            ...
            n(a[e])
              ...
              : ((b[e] = a[e]),
                !a.isArc ||
                  ("wa" !== a[e] && "at" !== a[e]) ||
                  (b[e + 5] === b[e + 7] &&
                    (b[e + 7] += a[e + 7] > a[e + 5] ? 1 : -1),
                  b[e + 6] === b[e + 8] &&
                    (b[e + 8] += a[e + 8] > a[e + 6] ? 1 : -1)));
          return b.join(" ") || "x";
        },
        clip: function (a) {
          var e = this,
          ...
          a
            ...
            : (e.destroyClip && e.destroyClip(),
              (a = { clip: e.docMode8 ? "inherit" : "rect(auto)" }));
          return e.css(a);
        },
        ...
        shadow: function (a, c, q) {
          ...
          if (a) {
            ...
            for (k = 1; 3 >= k; k++)
              (l = 2 * z + 1 - 2 * k),
                q && (t = this.cutOffPath(B.value, l + 0.5)),
                (g = [
                ...
                (x = G(d.prepVML(g), null, {
                  left: b(n.left) + m(a.offsetX, 1),
                ...
                G(d.prepVML(g), null, null, x),
                c ? c.element.appendChild(x) : r.parentNode.insertBefore(x, r),
                e.push(x);
            this.shadows = e;
          }
          return this;
      ...
      (a.VMLElement = C = D(q, C)),
      (C.prototype.ySetter =
        C.prototype.widthSetter =
        C.prototype.heightSetter =
          C.prototype.xSetter),
      (C = {
        Element: C,
        ...
        color: function (b, c, m, q) {
          ...
          if (x) {
            ...
            var h,
              ...
              v = function () {
                n = [
                  '\x3cfill colors\x3d"' + y.join(",") + '" opacity\x3d"',
                  H,
                  '" o:opacity2\x3d"',
                  F,
                  '" type\x3d"',
            ...
            l(b, function (g, b) {
              d.test(g[1])
                ? ((r = a.color(g[1])), (B = r.get("rgb")), (t = r.get("a")))
                : ((B = g[1]), (t = 1));
              y.push(100 * g[0] + "% " + B);
              b ? ((H = t), (A = B)) : ((F = t), (u = B));
            });
            if ("fill" === m)
              if ("gradient" === x)
                (m = z.x1 || z[0] || 0),
                  ...
                  (p =
                    'angle\x3d"' +
                    (90 - (180 * Math.atan((z - b) / (f - m))) / Math.PI) +
                    '"'),
                  v();
              else {
                var g = z.r,
                  ...
                  g = function () {
                    L &&
                      ((T = q.getBBox()),
                      (I += (L[0] - T.x) / T.width - 0.5),
                      (U += (L[1] - T.y) / T.height - 0.5),
                      (C *= L[2] / T.width),
                      (D *= L[2] / T.height));
                    p =
                      'src\x3d"' +
            ...
            d.test(b) && "IMG" !== c.tagName
              ? ((r = a.color(b)),
                q[m + "-opacitySetter"](r.get("a"), m, c),
                (g = r.get("rgb")))
              : ((g = c.getElementsByTagName(m)),
                g.length && ((g[0].opacity = 1), (g[0].type = "solid")),
                (g = b));
          return g;
        },
        prepVML: function (a) {
        ...
        createElement: function (a) {
          return "rect" === a
            ? this.symbol(a)
            : z.prototype.createElement.call(this, a);
        },
        ...
        symbols: {
          ...
          rect: function (a, b, c, m, k) {
            return z.prototype.symbols[h(k) && k.r ? "callout" : "square"].call(
              0,
              a,
              b,
              c,
  ...
  (function (a) {
    function D() {
      ...
      l.hcMakeTime = function (a, c, d, m, b, q) {
        var n;
        u
          ? ((n = l.UTC.apply(0, arguments)), (n += I(n)))
          : (n = new l(a, c, f(d, 1), f(m, 0), f(b, 0), f(q, 0)).getTime());
        return n;
      };
    ...
    a.defaultOptions = {
      ...
      global: {
        ...
        VMLRadialGradientURL:
          "http://code.highcharts.com/5.0.6/gfx/vml-radial-gradient.png",
      },
      chart: {
        borderRadius: 0,
  ...
  (function (a) {
    ...
    a.PlotLineOrBand.prototype = {
      render: function () {
        var a = this,
          ...
          N = q ? "bands" : "lines",
          g = f.log2lin;
        f.isLog && ((m = g(m)), (t = g(t)), (b = g(b)));
        z
          ? ((r = { stroke: A, "stroke-width": c.width }),
      ...
      renderLabel: function (a, f, d, c) {
        ...
        n ||
          ...
          (n.zIndex = c),
          (this.label = n = l.text(a.text, 0, 0, a.useHTML).attr(n).add()),
          n.css(a.style));
        c = [f[1], f[4], d ? f[6] : f[1]];
        f = [f[2], f[5], d ? f[7] : f[2]];
        d = C(c);
    ...
    a.AxisPlotLineOrBandExtension = {
      getPlotBandPath: function (a, f) {
        ...
        (a = this.getPlotLinePath(a, null, null, !0)) && f
          ? ((a.flat = a.toString() === f.toString()),
            a.push(f[4], f[5], f[1], f[2], "z"))
          : (a = null);
        return a;
      },
  ...
  (function (a) {
    ...
    a.Tick.prototype = {
      addLabel: function () {
        ...
        a.isDatetimeAxis &&
          t &&
          (q = l.dateTimeLabelFormats[t.higherRanks[n] || t.unitName]);
        this.isFirst = m;
        this.isLast = b;
      ...
      handleOverflow: function (a) {
        var l = this.axis,
          ...
          y = this.label,
          t = this.rotation,
          m = { left: 0, center: 0.5, right: 1 }[l.labelAlign],
          b = y.getBBox().width,
          q = l.getSlotWidth(),
          z = q,
          F = 1,
        ...
        if (t)
          0 > t && h - m * b < n
            ? (e = Math.round(h / Math.cos(t * p) - n))
            : 0 < t &&
              h + m * b > c &&
              (e = Math.round((d - h) / Math.cos(t * p)));
        else if (
          ((d = h + (1 - m) * b),
          h - m * b < n
            ? (z = a.x + z * (1 - m) - n)
          ...
          z < q &&
            "center" === l.labelAlign &&
            (a.x += F * (q - z - m * (q - Math.min(b, z)))),
          b > z || (l.autoRotation && (y.styles || {}).width))
        )
          e = z;
        e &&
          ((r.width = e),
      ...
      getPosition: function (a, f, h, d) {
        ...
        return {
          x: a
            ? c.translate(f + h, null, null, d) + c.transB
            : c.left +
              c.offset +
              (c.opposite
                ? ((d && n.oldChartWidth) || n.chartWidth) - c.right - c.left
                : 0),
          y: a
            ? l - c.bottom + c.offset - (c.opposite ? c.height : 0)
            : l - c.translate(f + h, null, null, d) - c.transB,
        };
      },
        ...
        C(e) ||
          (e =
            0 === m.side
              ...
              : 2 === m.side
              ? l.y + 8
              : Math.cos(h.rotation * p) * (l.y - h.getBBox(!1, 0).height / 2));
      ...
      render: function (a, l, h) {
        ...
        if (
          !l &&
          z &&
          (b = d.getPlotLinePath(b + K, z.strokeWidth() * g, l, !0))
        )
          z[this.isNew ? "attr" : "animate"]({ d: b, opacity: h });
        e &&
          (d.opposite && (e[0] = -e[0]),
          x &&
            ((this.mark = r =
              n
                ...
                .add(d.axisGroup)),
            r.attr({ stroke: F, "stroke-width": B })),
          r[x ? "attr" : "animate"]({
            d: this.getMarkPath(u, J, e[0], r.strokeWidth() * g, p, n),
            opacity: h,
          }));
        m &&
          I(u) &&
          ((m.xy = J = this.getLabelPosition(u, J, m, p, q, K, a, A)),
          (this.isFirst && !this.isLast && !f(c.showFirstLabel, 1)) ||
          (this.isLast && !this.isFirst && !f(c.showLastLabel, 1))
            ? (w = !1)
            : !p ||
              d.isRadial ||
              q.step ||
              ...
              l ||
              0 === h ||
              this.handleOverflow(J),
          A && a % A && (w = !1),
          w && I(J.y)
            ? ((J.opacity = h), m[this.isNew ? "attr" : "animate"](J))
            : m.attr("y", -9999),
          (this.isNew = !1));
      },
      destroy: function () {
  ...
  (function (a) {
    ...
    a.Axis.prototype = {
      ...
      init: function (a, b) {
        ...
        this.crosshair = A(
          c.crosshair,
          K(a.options.tooltip.crosshairs)[g ? 0 : 1],
          !1
        );
        var k;
        b = this.options.events;
        -1 === q(this, a.axes) &&
          (g ? a.axes.splice(a.xAxis.length, 0, this) : a.axes.push(this),
        ...
        c(a.series, function (g) {
          if (g.visible || !e.options.chart.ignoreHiddenSeries) {
            ...
            if (a.isXAxis)
              (c = g.xData),
                c.length &&
                  ...
                  F(g) ||
                    ...
                    (g = I(c))),
                  (a.dataMin = Math.min(A(a.dataMin, c[0]), g)),
                  (a.dataMax = Math.max(A(a.dataMax, c[0]), G(c))));
            else if (
              (g.getExtremes(),
              (B = g.dataMax),
              (g = g.dataMin),
              l(g) &&
                l(B) &&
                ((a.dataMin = Math.min(A(a.dataMin, g), g)),
                (a.dataMax = Math.max(A(a.dataMax, B), B))),
              l(k) && (a.threshold = k),
              !c.softThreshold || a.isLog)
            )
              a.softThreshold = !1;
          }
        });
      ...
      translate: function (a, b, c, e, k, m) {
        ...
        b
          ? ((a = (a * B + q - r) / d + e), k && (a = g.lin2val(a)))
          : (k && (a = g.val2lin(a)),
            (a = B * (a - e) * d + q + B * r + (F(m) ? d * m : 0)));
        return a;
      },
      ...
      getPlotLinePath: function (a, b, c, e, k) {
        ...
        F(k)
          ? this.horiz
            ? ((q = m),
              (d = r - this.bottom),
              (a = c = w(a, B, B + this.width)))
            : ((a = B),
              (c = n - this.right),
              (q = d = w(q, m, m + this.height)))
          : (f = !0);
        return f && !e
          ? null
          : g.renderer.crispLine(["M", a, q, "L", c, d], b || 1);
      },
      ...
      adjustForMinRange: function () {
        ...
        this.isXAxis &&
          ...
          (l(a.min) || l(a.max)
            ...
            : (c(this.series, function (a) {
                f = a.xData;
                for (d = n = a.xIncrement ? 1 : f.length - 1; 0 < d; d--)
        ...
        k - b < this.minRange &&
          ...
          (e = (w - k + b) / 2),
          (e = [b - e, A(a.min, b - e)]),
          m && (e[2] = this.isLog ? this.log2lin(this.dataMin) : this.dataMin),
          (b = G(e)),
          (k = [b + w, A(a.max, b + w)]),
          m && (k[2] = this.isLog ? this.log2lin(this.dataMax) : this.dataMax),
          (k = I(k)),
          k - b < w && ((e[0] = k - w), (e[1] = A(a.min, k - w)), (b = G(e))));
        this.min = b;
        this.max = k;
      },
      getClosest: function () {
      ...
      setAxisTranslation: function (a) {
        ...
        if (w || f || k)
          (m = b.getClosest()),
            r
              ? ((q = r.minPointOffset), (d = r.pointRangePadding))
              : c(b.series, function (a) {
                  var g = f
                    ? 1
                    : w
                    ? A(a.options.pointRange, m, 0)
                    : b.axisPointRange || 0;
                  a = a.options.pointPlacement;
                  k = Math.max(k, g);
                  b.single ||
                    ((q = Math.max(q, e(a) ? 0 : g / 2)),
                    (d = Math.max(d, "on" === a ? 0 : g)));
                }),
            (r = b.ordinalSlope && m ? b.ordinalSlope / m : 1),
            (b.minPointOffset = q *= r),
            (b.pointRangePadding = d *= r),
            (b.pointRange = Math.min(k, g)),
            w && (b.closestPointRange = m);
        a && (b.oldTransA = n);
      ...
      setTickInterval: function (b) {
        ...
        D = A(g.userMax, e.max);
        n
          ? ((g.linkedParent = k[g.coll][e.linkedTo]),
            (k = g.linkedParent.getExtremes()),
            (g.min = A(k.min, k.dataMin)),
            (g.max = A(k.max, k.dataMax)),
            e.type !== g.linkedParent.options.type && a.error(11, 1))
          : (!u &&
              l(J) &&
              (g.dataMin >= J
                ? ((N = J), (t = 0))
                : g.dataMax <= J && ((v = J), (w = 0))),
            (g.min = A(C, N, g.dataMin)),
            (g.max = A(D, v, g.dataMax)));
        q &&
          (!b && 0 >= Math.min(g.min, A(g.dataMin, g.min)) && a.error(10, 1),
          (g.min = p(d(g.min), 15)),
          (g.max = p(d(g.max), 15)));
        g.range &&
          l(g.max) &&
          ((g.userMin = g.min = C = Math.max(g.min, g.minFromRange())),
          (g.userMax = D = g.max),
          (g.range = null));
        y(g, "foundExtremes");
        g.beforePadding && g.beforePadding();
        g.adjustForMinRange();
        !(K || g.axisPointRange || g.usePercentage || n) &&
          l(g.min) &&
          l(g.max) &&
          (d = g.max - g.min) &&
          (!l(C) && t && (g.min -= d * t), !l(D) && w && (g.max += d * w));
        F(e.floor)
          ? (g.min = Math.max(g.min, e.floor))
          : F(e.softMin) && (g.min = Math.min(g.min, e.softMin));
        F(e.ceiling)
          ? (g.max = Math.min(g.max, e.ceiling))
          : F(e.softMax) && (g.max = Math.max(g.max, e.softMax));
        u &&
          l(g.dataMin) &&
          ((J = J || 0),
          !l(C) && g.min < J && g.dataMin >= J
            ? (g.min = J)
            : !l(D) && g.max > J && g.dataMax <= J && (g.max = J));
        g.tickInterval =
          g.min === g.max || void 0 === g.min || void 0 === g.max
            ? 1
            : n && !z && h === g.linkedParent.options.tickPixelInterval
            ? (z = g.linkedParent.tickInterval)
            : A(
                z,
                this.tickAmount
                  ? (g.max - g.min) / Math.max(this.tickAmount - 1, 1)
                  : void 0,
                K ? 1 : ((g.max - g.min) * h) / Math.max(g.len, h)
              );
        f &&
          !b &&
        ...
        g.postProcessTickInterval &&
          (g.tickInterval = g.postProcessTickInterval(g.tickInterval));
        g.pointRange &&
          !z &&
      ...
      setTickPositions: function () {
        ...
        !b &&
          ...
          k && (k = k.apply(this, [this.min, this.max]))) &&
          (this.tickPositions = b = k);
        this.isLinked ||
          (this.trimTicks(b, e, m),
          this.min === this.max &&
            l(this.min) &&
            !this.tickAmount &&
            ((q = !0), (this.min -= 0.5), (this.max += 0.5)),
          (this.single = q),
          c || k || this.adjustTickAmount());
      },
      ...
      setAxisSize: function () {
        ...
        c.test(q) &&
          (q = Math.round((parseFloat(q) / 100) * a.plotHeight + a.plotTop));
        this.left = b;
        this.top = q;
        this.width = e;
        this.height = m;
      ...
      unsquish: function () {
        var a = this.options.labels,
          ...
          e = k,
          m =
            this.len / (((this.categories ? 1 : 0) + this.max - this.min) / k),
          q,
          d = a.rotation,
          r = this.labelMetrics(),
          f,
        ...
        b
          ? (w =
              ...
              (l(d)
                ? [d]
                : m < A(a.autoRotationLimit, 80) && a.autoRotation)) &&
            c(w, function (a) {
              var b;
              if (a === d || (a && -90 <= a && 90 >= a))
                (f = t(Math.abs(r.h / Math.sin(u * a)))),
                  (b = f + Math.abs(a / 360)),
                  b < n && ((n = b), (q = a), (e = f));
            })
          : a.step || (e = t(r.h));
      ...
      getSlotWidth: function () {
        ...
        return (
          (b &&
            2 > (c.step || 0) &&
            !c.rotation &&
            ((this.staggerLines || 1) * a.plotWidth) / k) ||
          (!b && ((e && e - a.spacing[3]) || 0.33 * a.chartWidth))
        );
      },
      renderUnsquish: function () {
        ...
        else if (f && ((h = { width: n + "px" }), !z))
          for (h.textOverflow = "clip", x = k.length; !d && x--; )
            if (((F = k[x]), (n = m[F].label)))
              n.styles && "ellipsis" === n.styles.textOverflow
                ? n.css({ textOverflow: "clip" })
                : m[F].labelLength > f && n.css({ width: f + "px" }),
                n.getBBox().height > this.len / k.length - (t.h - t.f) &&
                  (n.specCss = { textOverflow: "ellipsis" });
        w.rotation &&
          ((h = {
            width:
              (l > 0.5 * a.chartHeight ? 0.33 * a.chartHeight : a.chartHeight) +
              "px",
          }),
          z || (h.textOverflow = "ellipsis"));
        if (
          (this.labelAlign = q.align || this.autoLabelAlign(this.labelRotation))
        )
      ...
      addTitle: function (a) {
        ...
        this.axisTitle ||
          ...
          (this.axisTitle = b
            ...
            .attr({ zIndex: 7, rotation: k.rotation || 0, align: e })
      ...
      getOffset: function () {
        ...
        a.axisGroup ||
          ((a.gridGroup = k
            ...
            .addClass(
              "highcharts-" + this.coll.toLowerCase() + "-grid " + (y || "")
            )
            .add(v)),
          (a.axisGroup = k
            .g("axis")
            .attr({ zIndex: e.zIndex || 2 })
            .addClass("highcharts-" + this.coll.toLowerCase() + " " + (y || ""))
            .add(v)),
          (a.labelGroup = k
            .g("axis-labels")
            .attr({ zIndex: F.zIndex || 7 })
            .addClass(
              "highcharts-" + a.coll.toLowerCase() + "-labels " + (y || "")
            )
            .add(v)));
        if (w || a.isLinked)
          c(m, function (b) {
        ...
        else for (u in q) q[u].destroy(), delete q[u];
        x &&
          x.text &&
          !1 !== x.enabled &&
          (a.addTitle(f),
          f &&
            ((t = a.axisTitle.getBBox()[d ? "height" : "width"]),
            (z = x.offset),
            (h = l(z) ? 0 : A(x.margin, d ? 5 : 10))));
        a.renderLine();
        ...
        K[r] = Math.max(
          K[r],
          a.axisTitleMargin + t + J * a.offset,
          h,
          w && m.length && C ? C[0] : 0
        );
      ...
      getLinePath: function (a) {
        ...
        return b.renderer.crispLine(
          [
            ...
            k ? g : this.top,
            "L",
            k ? b.chartWidth - this.right : e,
            k ? g : b.chartHeight - this.bottom,
          ],
          a
        );
      },
      ...
      render: function () {
        ...
        if (a.hasData() || r)
          a.minorTickInterval &&
            ...
            n.length &&
              (c(n, function (b, c) {
                if (!r || (b >= a.min && b <= a.max))
                  f[b] || (f[b] = new N(a, b)),
                    A && f[b].isNew && f[b].render(c, !0, 0.1),
                    f[b].render(c);
              }),
              x &&
                (0 === a.min || a.single) &&
                (f[-1] || (f[-1] = new N(a, -1, null, !0)), f[-1].render(-1))),
            l &&
              c(n, function (c, g) {
            ...
            a._addedPlotLB ||
              (c((m.plotLines || []).concat(m.plotBands || []), function (b) {
        ...
        c([f, t, z], function (a) {
          ...
          for (c in a)
            a[c].isActive ||
              (a[c].render(c, !1, 0), (a[c].isActive = !1), k.push(c));
          J(
            function () {
              for (g = k.length; g--; )
                a[k[g]] &&
                  !a[k[g]].isActive &&
                  (a[k[g]].destroy(), delete a[k[g]]);
            },
        ...
        w &&
          K &&
          (w[w.isNew ? "attr" : "animate"](a.getTitlePosition()),
          (w.isNew = !1));
      ...
      drawCrosshair: function (a, b) {
        ...
        this.crosshair && !1 !== (l(b) || !k)
          ? (k
              ? l(b) && (e = this.isXAxis ? b.plotX : this.len - b.plotY)
              : (e =
                  a &&
                  (this.horiz
                    ? a.chartX - this.pos
            ...
            l(e) &&
              (c =
                this.getPlotLinePath(
                  b && (this.isXAxis ? b.x : A(b.stackY, b.y)),
                  null,
                  null,
                  null,
                  e
            ...
            l(c)
              ? ((b = this.categories && !this.isRadial),
                ...
                m.show().attr({ d: c }),
                b && !g.width && m.attr({ "stroke-width": this.transA }),
                (this.cross.e = a))
              : this.hideCrosshair())
          : this.hideCrosshair();
      },
  ...
  (function (a) {
    ...
    D.prototype.getTimeTicks = function (a, y, t, m) {
      var b = [],
        ...
        k;
      if (h(y)) {
        e[C.hcSetMilliseconds](
          x >= c.second ? 0 : A * Math.floor(e.getMilliseconds() / A)
        );
        if (x >= c.second)
          e[C.hcSetSeconds](
            x >= c.minute ? 0 : A * Math.floor(e.getSeconds() / A)
          );
        if (x >= c.minute)
          e[C.hcSetMinutes](
            x >= c.hour ? 0 : A * Math.floor(e[C.hcGetMinutes]() / A)
          );
        if (x >= c.hour)
          e[C.hcSetHours](
            x >= c.day ? 0 : A * Math.floor(e[C.hcGetHours]() / A)
          );
        if (x >= c.day)
          e[C.hcSetDate](
            x >= c.month ? 1 : A * Math.floor(e[C.hcGetDate]() / A)
          );
        x >= c.month &&
          (e[C.hcSetMonth](
            x >= c.year ? 0 : A * Math.floor(e[C.hcGetMonth]() / A)
          ),
          (F = e[C.hcGetFullYear]()));
        if (x >= c.year) e[C.hcSetFullYear](F - (F % A));
        if (x === c.week)
          e[C.hcSetDate](e[C.hcGetDate]() - e[C.hcGetDay]() + d(m, 1));
        F = e[C.hcGetFullYear]();
        m = e[C.hcGetMonth]();
        var w = e[C.hcGetDate](),
          K = e[C.hcGetHours]();
        if (C.hcTimezoneOffset || C.hcGetTimezoneOffset)
          (k =
            (!n || !!C.hcGetTimezoneOffset) &&
            (t - y > 4 * c.month || l(y) !== l(t))),
            (e = e.getTime()),
            (e = new C(e + l(e)));
        n = e.getTime();
        for (y = 1; n < t; )
    ...
    D.prototype.normalizeTimeTickInterval = function (a, d) {
      ...
      for (
        ...
        (m = c[d[0]]),
        (b = d[1]),
        f[q + 1] && a <= (m * b[b.length - 1] + c[f[q + 1][0]]) / 2);
        q++
      );
  ...
  (function (a) {
    ...
    D.prototype.getLogTickPositions = function (a, p, v, l) {
      ...
      if (0.5 <= a)
        (a = Math.round(a)), (y = this.getLinearTickPositions(a, p, v));
      else if (0.08 <= a)
        for (
          var d = Math.floor(p),
            t,
          ...
          for (m = f.length, t = 0; t < m && !z; t++)
            (b = n(c(d) * f[t])),
              b > p && (!l || q <= v) && void 0 !== q && y.push(q),
              q > v && (z = !0),
              (q = b);
      else
        (p = c(p)),
          (v = c(v)),
          (a = f[l ? "minorTickInterval" : "tickInterval"]),
          (a = h(
            "auto" === a ? null : a,
            this._minorAutoInterval,
            ((f.tickPixelInterval / (l ? 5 : 1)) * (v - p)) /
              ((l ? d / this.tickPositions.length : d) || 1)
          )),
          (a = I(a, null, C(a))),
          (y = G(this.getLinearTickPositions(a, p, v), n)),
  ...
  (function (a) {
    ...
    a.Tooltip.prototype = {
      ...
      move: function (a, d, f, t) {
        var c = this,
          ...
          q =
            ...
            !c.isHidden &&
            (1 < Math.abs(a - b.x) || 1 < Math.abs(d - b.y)),
          n = c.followPointer || 1 < c.len;
        G(b, {
          x: q ? (2 * b.x + a) / 3 : a,
          y: q ? (b.y + d) / 2 : d,
          anchorX: n ? void 0 : q ? (2 * b.anchorX + f) / 3 : f,
          anchorY: n ? void 0 : q ? (b.anchorY + t) / 2 : t,
        });
        c.getLabel().attr(b);
        q &&
          (clearTimeout(this.tooltipTimeout),
      ...
      getAnchor: function (a, d) {
        ...
        this.followPointer &&
          d &&
          (void 0 === d.chartX && (d = n.pointer.normalize(d)),
      ...
      getPosition: function (a, d, f) {
        var c = this.chart,
          ...
          p = function (a, c, k, g) {
            ...
            g < m || g > c - m
              ? (e = !1)
              : (b[a] = g < k / 2 ? 1 : g > c - k / 2 ? c - k - 2 : g - k / 2);
            return e;
          },
          k = function (a) {
            var b = h;
      ...
      refresh: function (a, d) {
        ...
        d = q[0];
        b = q[1];
        !e || (a.series && a.series.noSharedTooltip)
          ? (n = a.getLabelConfig())
          : ((c.hoverPoints = a),
            n &&
              C(n, function (a) {
        ...
        !1 === n
          ...
          : ((f = this.getLabel()),
            ...
            this.split
              ? this.renderSplit(n, c.hoverPoints)
              : (f.attr({ text: n && n.join ? n.join("") : n }),
                f
                  .removeClass(/highcharts-color-[\d]+/g)
                  .addClass(
                    "highcharts-color-" + v(a.colorIndex, e.colorIndex)
                  ),
                f.attr({
        ...
        C(c.slice(0, c.length - 1), function (a, c) {
          ...
          k ||
            (r.tt = k =
              b
                ...
                .addClass("highcharts-tooltip-box " + t)
                .attr({
                  padding: h.padding,
                  r: h.borderRadius,
          ...
          c.isHeader
            ? ((l = a.height),
              (w = Math.max(
                0,
                Math.min(c.plotX + m.plotLeft - w / 2, m.chartWidth - w)
              )))
            : (w = c.plotX + m.plotLeft - v(h.distance, 16) - w);
          0 > w && (q = !1);
          a =
            (c.series && c.series.yAxis && c.series.yAxis.pos) + (c.plotY || 0);
          a -= m.plotTop;
          n.push({
            target: c.isHeader ? m.plotHeight + l : a,
            rank: c.isHeader ? 1 : 0,
      ...
      getXDateFormat: function (a, f, h) {
        ...
        if (m) {
          ...
          for (b in d) {
            ...
            if (q[b] && n.substr(q[b]) !== "01-01 00:00:00.000".substr(q[b]))
              break;
            "week" !== b && (l = b);
          }
          b && (c = f[b]);
  ...
  (function (a) {
    ...
    a.Pointer.prototype = {
      init: function (a, m) {
        ...
        t &&
          m.tooltip.enabled &&
          ((a.tooltip = new t(a, m.tooltip)),
          (this.followTouchMove = c(m.tooltip.followTouchMove, !0)));
        this.setDOMEvents();
      },
      ...
      normalize: function (a, c) {
        ...
        void 0 === q.pageX
          ...
          : ((b = q.pageX - c.left), (c = q.pageY - c.top));
      ...
      runPointActions: function (b) {
        ...
        h && (e ? h.noSharedTooltip : h.directTouch) && n
          ? (t = [n])
          : (e || !h || h.options.stickyTracking || (d = [h]),
            v(d, function (a) {
              ...
              a.visible &&
                ...
                (u = a.searchPoint(b, !w && 1 === a.kdDimensions)) &&
                u.series &&
                t.push(u);
            }),
            t.sort(function (a, b) {
        ...
        if (e)
          for (k = t.length; k--; )
            (t[k].x !== t[0].x || t[k].series.noSharedTooltip) &&
              t.splice(k, 1);
        if (t[0] && (t[0] !== this.prevKDPoint || (f && f.isHidden))) {
          ...
          } else if ((f && f.refresh(t[0], b), !h || !h.directTouch))
            t[0].onMouseOver(b);
          this.prevKDPoint = t[0];
          r = !1;
        }
        r &&
          ((d = h && h.tooltipOptions.followPointer),
          f &&
            d &&
            !f.isHidden &&
            ((d = f.getAnchor([{}], b)),
            f.updatePosition({ plotX: d[0], plotY: d[1] })));
        this.unDocMouseMove ||
          (this.unDocMouseMove = D(p, "mousemove", function (b) {
            if (G[a.hoverChartIndex])
              G[a.hoverChartIndex].pointer.onDocumentMouseMove(b);
          }));
        v(e ? t : [c(n, t[0])], function (a) {
          v(m.axes, function (c) {
            (!a || (a.series && a.series[c.coll] === c)) &&
              c.drawCrosshair(b, a);
          });
        });
      },
      ...
      scaleGroups: function (a, c) {
        ...
        v(b.series, function (e) {
          ...
          e.xAxis &&
            ...
            (e.group.attr(m),
            e.markerGroup &&
              (e.markerGroup.attr(m),
              e.markerGroup.clip(c ? b.clipRect : null)),
            e.dataLabelsGroup && e.dataLabelsGroup.attr(m));
        });
      ...
      drag: function (a) {
        ...
        (t && t.touch) ||
          ...
          (this.hasDragged = Math.sqrt(
            Math.pow(g - m, 2) + Math.pow(p - e, 2)
          )),
          10 < this.hasDragged &&
            ((l = b.isInsidePlot(g - n, p - k)),
            b.hasCartesianSeries &&
              (this.zoomX || this.zoomY) &&
              l &&
              !u &&
              !t &&
              (this.selectionMarker = t =
                b.renderer
                  .rect(n, k, d ? 1 : w, f ? 1 : h, 0)
                  .attr({
                    fill:
                      c.selectionMarkerFill ||
                      I("#335cad").setOpacity(0.25).get(),
            ...
            t &&
              d &&
              ((m -= g),
              t.attr({ width: Math.abs(m), x: (0 < m ? 0 : m) + g })),
            t &&
              f &&
              ((m = e - p),
              t.attr({ height: Math.abs(m), y: (0 < m ? 0 : m) + p })),
      ...
      drop: function (a) {
          ...
          if (this.hasDragged || m)
            v(c.axes, function (c) {
              if (
                c.zoomEnabled &&
                f(c.min) &&
                (m || b[{ xAxis: "zoomX", yAxis: "zoomY" }[c.coll]])
              ) {
                var d = c.horiz,
        ...
        c &&
          (h(c.container, { cursor: c._cursor }),
      ...
      onContainerClick: function (a) {
        ...
        b.cancelClick ||
          (c && this.inClass(a.target, "highcharts-tracker")
            ? (u(c.series, "click", l(a, { point: c })),
              b.hoverPoint && c.firePointEvent("click", a))
            : (l(a, this.getCoordinates(a)),
              b.isInsidePlot(a.chartX - m, a.chartY - e) && u(b, "click", a)));
      },
      ...
      destroy: function () {
        ...
        a.chartCount ||
          (n(p, "mouseup", this.onDocumentMouseUp),
          n(p, "touchend", this.onDocumentTouchEnd));
  ...
  (function (a) {
    ...
    G(a.Pointer.prototype, {
      pinchTranslate: function (a, f, h, u, d, c) {
        ...
        this.zoomVert && this.pinchTranslateDirection(!1, a, f, h, u, d, c);
      },
      pinchTranslateDirection: function (a, f, h, u, d, c, n, y) {
        ...
        f < k.min
          ? ((f = k.min), (B = !0))
          : f + e > k.max && ((f = k.max - e), (B = !0));
        B
          ? ((J -= 0.8 * (J - n[m][0])), w || (g -= 0.8 * (g - n[m][1])), h())
          : (n[m] = [J, g]);
        A || ((c[m] = r - p), (c[l] = e));
        c = A ? 1 / x : x;
        d[l] = e;
      ...
      pinch: function (a) {
        var p = this,
          ...
          b =
            1 === c &&
            ((p.inClass(a.target, "highcharts-tracker") && l.runTrackerClick) ||
              p.runChartClick),
          q = {};
        1 < c && (p.initiated = !0);
        ...
        "touchstart" === a.type
          ? (C(d, function (a, b) {
            ...
            (p.res = !0))
          : p.followTouchMove && 1 === c
          ? this.runPointActions(p.normalize(a))
          : u.length &&
            (t ||
              (p.selectionMarker = t = G({ destroy: h, touch: !0 }, l.plotBox)),
            p.pinchTranslate(u, d, m, t, q, n),
            (p.hasPinched = y),
            p.scaleGroups(m, q),
      ...
      touch: function (h, v) {
        ...
        1 === h.touches.length
          ? ((h = this.normalize(h)),
            (d = l.isInsidePlot(h.chartX - l.plotLeft, h.chartY - l.plotTop)) &&
            !l.openMenu
              ? (v && this.runPointActions(h),
                "touchmove" === h.type &&
                  ((v = this.pinchDown),
                  (p = v[0]
                    ? 4 <=
                      Math.sqrt(
                        Math.pow(v[0].chartX - h.chartX, 2) +
                          Math.pow(v[0].chartY - h.chartY, 2)
                      )
                    : !1)),
                f(p, !0) && this.pinch(h))
              : v && this.reset())
  ...
  (function (a) {
    ...
    D.prototype = {
      ...
      positionItem: function (a) {
        ...
        (a = a.legendGroup) &&
          a.element &&
          a.translate(b ? m : this.legendWidth - m - 2 * c - 4, d);
        e && ((e.x = m), (e.y = d));
      },
      ...
      setText: function (c) {
        ...
        c.legendItem.attr({
          text: b.labelFormat
            ? a.format(b.labelFormat, c)
            : b.labelFormatter.call(c),
        });
      },
      renderItem: function (a) {
          ...
          ((a.legendGroup = c
            ...
            .addClass(
              "highcharts-" +
                ...
                a.colorIndex +
                (a.options.className ? " " + a.options.className : "") +
        ...
        e = a.checkboxOffset =
          m.itemWidth ||
          a.legendItemWidth ||
          e + h + c.width + w + (E ? 20 : 0);
        this.itemHeight = h = Math.round(a.legendItemHeight || c.height);
        f &&
          this.itemX - B + e > (p || b.chartWidth - 2 * k - B - m.x) &&
          ((this.itemX = B),
          (this.itemY += g + this.lastLineHeight + y),
        ...
        this.offsetWidth =
          p || Math.max((f ? this.itemX - B - w : e) + k, this.offsetWidth);
      },
      ...
      adjustMargins: function (a, b) {
        var c = this.chart,
          m = this.options,
          n =
            m.align.charAt(0) + m.verticalAlign.charAt(0) + m.layout.charAt(0);
        m.floating ||
          f(
      ...
      render: function () {
        ...
        0 < r &&
          ...
          (t[t.isNew ? "attr" : "animate"](
            t.crisp({ x: 0, y: 0, width: r, height: l }, t.strokeWidth())
          ),
          (t.isNew = !1));
        t[e ? "show" : "hide"]();
        a.legendWidth = r;
      ...
      handleOverflow: function (a) {
        ...
        u.length = 0;
        a > c && !1 !== t.enabled
          ? ((this.clipHeight = n = Math.max(c - 20 - this.titleHeight - y, 0)),
            ...
            f(B, function (a, b) {
              ...
              var k = u.length;
              if (!k || (c - u[k - 1] > n && (g || c) !== u[k - 1]))
                u.push(g || c), k++;
              b === B.length - 1 && c + a - u[k - 1] > n && u.push(c);
              c !== g && (g = c);
            }),
            l ||
              ((l = b.clipRect = m.clipRect(0, y, 9999, 0)),
              b.contentGroup.clip(l)),
            v(n),
            p ||
              ((this.nav = p = m.g().attr({ zIndex: 1 }).add(this.group)),
              (this.up = m
                .symbol("triangle", 0, 0, w, w)
                .on("click", function () {
                  b.scroll(-1, k);
                })
                .add(p)),
      ...
      scroll: function (a, b) {
        ...
        0 < a &&
          ...
          this.down
            .attr({ fill: a === f ? e.inactiveColor : e.activeColor })
    ...
    a.LegendSymbolMixin = {
      drawRectangle: function (a, b) {
        ...
        b.legendSymbol = this.chart.renderer
          .rect(
            c ? (a.symbolWidth - f) / 2 : 0,
            a.baseline - f + 1,
            c ? f : a.symbolWidth,
            f,
            d(a.options.symbolRadius, f / 2)
          )
      ...
      drawLineMarker: function (a) {
        ...
        c &&
          !1 !== c.enabled &&
          ((b = 0 === this.symbol.indexOf("url") ? 0 : c.radius),
          (this.legendSymbol = c =
            f
    ...
    (/Trident\/7\.0/.test(y.navigator.userAgent) || v) &&
      t(D.prototype, "positionItem", function (a, b) {
        var c = this,
          d = function () {
    ...
    E.prototype = {
      ...
      redraw: function (b) {
        ...
        n(k, function (a) {
          a.isDirty &&
            ...
            (a.updateTotals && a.updateTotals(), (d = !0));
      ...
      layOutTitles: function (a) {
        ...
        n(
          ...
          function (a) {
            ...
            c &&
              ((d = e.style.fontSize),
              (d = k.fontMetrics(d, c).b),
              c
                .css({ width: (e.width || g.width + e.widthAdjust) + "px" })
                .align(
                  y({ y: b + d + ("title" === a ? -3 : 2) }, e),
                  !1,
                  "spacingBox"
                ),
              e.floating ||
        ...
        !this.isDirtyBox &&
          c &&
          ((this.isDirtyBox = c),
          this.hasRendered && w(a, !0) && this.isDirtyBox && this.redraw());
      },
      getChartSize: function () {
        ...
        this.chartHeight = Math.max(
          0,
          w(a, 19 < this.containerHeight ? this.containerHeight : 400)
        );
      },
      cloneRenderTo: function (a) {
        ...
        if (a) {
          ...
          c && c.parentNode === this.renderTo && this.renderTo.removeChild(c),
            ...
            d(b, { position: "absolute", top: "-9999px", display: "block" }),
            b.style.setProperty &&
      ...
      getContainer: function () {
        ...
        this.renderer = new (a[k.renderer] || R)(
          b,
          g,
          d,
          null,
      ...
      getMargins: function (a) {
        ...
        this.legend.display && this.legend.adjustMargins(k, b);
      ...
      reflow: function (a) {
        ...
        if (!d && !k.isPrinting && f && g && (e === M || e === h)) {
          if (f !== k.containerWidth || g !== k.containerHeight)
            clearTimeout(k.reflowTimeout),
              (k.reflowTimeout = S(
                function () {
      ...
      setChartSize: function (a) {
        ...
        this.clipBox = {
          ...
          height: Math.max(
            0,
            Math.floor(this.plotSizeY - Math.max(g, f[2]) / 2 - c)
          ),
        };
        a ||
      ...
      resetMargins: function () {
        ...
        n(["margin", "spacing"], function (c) {
          var g = b[c],
            k = F(g) ? g : [g, g, g, g];
          n(["Top", "Right", "Bottom", "Left"], function (g, e) {
            a[c][e] = w(b[c + g], k[e]);
          });
        });
        n(x, function (b, c) {
      ...
      drawChartBox: function () {
        ...
        h = { fill: h || "none" };
        if (f || k["stroke-width"])
          (h.stroke = a.borderColor), (h["stroke-width"] = f);
        ...
        K
          ? K.animate({ width: u.width, height: u.height })
      ...
      propFromSeries: function () {
        var a = this,
          ...
          k,
          e;
        n(["inverted", "angular", "polar"], function (d) {
          c = N[b.type || b.defaultSeriesType];
          e = b[d] || (c && c.prototype[d]);
          for (k = g && g.length; !e && k--; )
      ...
      linkSeries: function () {
        ...
        n(b, function (b) {
          ...
          e(c) &&
            ...
            (b.linkedParent = c),
            (b.visible = w(b.options.visible, c.options.visible, b.visible)));
        });
      },
      ...
      isReadyToRender: function () {
        var a = this;
        return B || M != M.top || "complete" === h.readyState
          ? !0
    ...
    a.Series = a.seriesType(
      ...
      },
      {
        ...
        init: function (a, b) {
          ...
          k._i = z(f && f._i, -1) + 1;
          for (a = this.insert(g); a < g.length; a++)
            (g[a].index = a),
              (g[a].name = g[a].name || "Series " + (g[a].index + 1));
        },
        insert: function (a) {
          ...
          u(b.axisTypes || [], function (k) {
            u(e[k], function (a) {
              ...
              if (
                c[k] === d.index ||
                (void 0 !== c[k] && c[k] === d.id) ||
                (void 0 === c[k] && 0 === d.index)
              )
                b.insert(a.series), (b[k] = a), (a.isDirty = !0);
            });
            ...
            e = m(b)
              ...
              : function (a) {
                  Array.prototype[b].apply(
                    c[a + "Data"],
                    Array.prototype.slice.call(k, 2)
                  );
                };
        ...
        autoIncrement: function () {
          ...
          e &&
            ...
            "day" === e
              ...
              : "year" === e &&
                (a = +a[f.hcSetFullYear](a[f.hcGetFullYear]() + c)),
            (c = a - b));
          this.xIncrement = b + c;
          return b;
        },
        setOptions: function (a) {
          ...
          this.tooltipOptions = q(
            ...
            b.tooltip,
            k.series && k.series.tooltip,
            k[this.type] && k[this.type].tooltip,
            a.tooltip
          );
        ...
        getCyclic: function (a, b, c) {
          ...
          b ||
            ((k = z(e[g], e["_" + g])),
            l(k) ||
              ((e["_" + g] = k = this.chart[d] % f), (this.chart[d] += 1)),
            c && (b = c[k]));
          void 0 !== k && (this[g] = k);
          this[a] = b;
        },
          ...
          if (
            ...
            if (p && n > p) {
              ...
              for (d = 0; d < n; d++)
                void 0 !== c[d] &&
                  ((l = { series: k }),
                  k.pointClass.prototype.applyOptions.apply(l, [c[d]]),
                  k.updateParallelArrays(l, d));
            b(A[0]) && a.error(14, !0);
            k.data = [];
        ...
        processData: function (b) {
          ...
          if (r && this.sorted && !l && (!h || e > h || this.forceCrop))
            if (c[e - 1] < t || c[0] > p) (c = []), (k = []);
            else if (c[0] < t || c[e - 1] > p)
              (d = this.cropData(this.xData, this.yData, t, p)),
                (c = d.xData),
                (k = d.yData),
                (d = d.start),
                (g = !0);
          for (h = c.length || 1; --h; )
            (e = q ? n(c[h]) - n(c[h - 1]) : c[h] - c[h - 1]),
              0 < e && (void 0 === f || e < f)
                ? (f = e)
        ...
        generatePoints: function () {
          ...
          for (t = 0; t < h; t++)
            (n = m + t),
              r
                ? ((l = new g().init(this, [d[t]].concat(e(f[t])))),
                  (l.dataGroup = this.groupMap[t]))
                : (l = b[n]) ||
                  void 0 === a[n] ||
                  (b[n] = l = new g().init(this, a[n], d[t])),
              (l.index = n),
              (q[t] = l);
          if (b && (h !== (c = b.length) || r))
            for (t = 0; t < c; t++)
        ...
        getExtremes: function (a) {
          ...
          for (r = 0; r < e; r++)
            if (
              ((n = c[r]),
              (l = a[r]),
              (h = (m(l, !0) || t(l)) && (!b.isLog || l.length || 0 < l)),
              (n =
        ...
        translate: function () {
          ...
          for (a = 0; a < f; a++) {
            ...
            var G =
                b &&
                d.stacks[
                  (this.negStacks && D < (p ? 0 : q) ? "-" : "") + this.stackKey
                ],
              I;
            ...
            y.plotX = x = h(
              Math.min(
                Math.max(
                  -1e5,
                  c.translate(C, 0, 0, 0, 1, r, "flags" === this.type)
                ),
                1e5
              )
            );
            b &&
              ...
              G &&
              G[C] &&
              ((F = this.getStackIndicator(F, C, this.index)),
              (I = G[C]),
              (D = I.points[F.key]),
              (u = D[0]),
              (D = D[1]),
              u === p && F.key === G[C].base && (u = z(q, d.min)),
              d.isLog && 0 >= u && (u = null),
              (y.total = y.stackTotal = I.total),
              (y.percentage = I.total && (y.y / I.total) * 100),
              (y.stackY = D),
              I.setOffset(this.pointXOffset || 0, this.barW || 0));
            y.yBottom = l(u) ? d.translate(u, 0, 1, 0, 1) : null;
            n && (D = this.modifyValue(D, y));
            y.plotY = u =
              "number" === typeof D && Infinity !== D
                ? Math.min(Math.max(-1e5, d.translate(D, 0, 1, 0, 1)), 1e5)
                : void 0;
            y.isInside =
              void 0 !== u && 0 <= u && u <= d.len && 0 <= x && x <= c.len;
            y.clientX = t ? h(c.translate(C, 0, 0, 0, 1, r)) : x;
            y.negative = y.y < (q || 0);
            y.category = e && void 0 !== e[y.x] ? e[y.x] : y.x;
            y.isNull ||
              (void 0 !== A && (v = Math.min(v, Math.abs(x - A))), (A = x));
        ...
        setClip: function (a) {
          ...
          h ||
            (a &&
              ...
              (b[f + "m"] = m =
                e.clipRect(
                  -99,
                  k ? -b.plotLeft : -b.plotTop,
                  99,
                  k ? b.chartWidth : b.chartHeight
                ))),
            (b[f] = h = e.clipRect(d)),
            (h.count = { length: 0 }));
          a &&
          ...
          !1 !== c.clip &&
            (this.group.clip(a || g ? h : b.clipRect),
        ...
        animate: function (a) {
          ...
          a
            ...
            : ((e = this.sharedClipKey),
              ...
              b[e + "m"] && b[e + "m"].animate({ width: b.plotSizeX + 99 }, c),
              (this.animate = null));
        },
          ...
          if (!1 !== f.enabled || this._hasPointMarkers)
            for (e = a.length; e--; )
              (d = a[e]),
                ...
                (h = d.marker || {}),
                (n = !!d.marker),
                (r = (q && void 0 === h.enabled) || h.enabled),
                (l = d.isInside),
                r && m(c) && null !== d.y
                  ? ((c = z(h.symbol, this.symbol)),
                    (d.hasImage = 0 === c.indexOf("url")),
                    (r = this.markerAttribs(d, d.selected && "select")),
                    g
                      ? g[l ? "show" : "hide"](!0).animate(r)
                      : l &&
                        (0 < r.width || d.hasImage) &&
                        (d.graphic = g =
                          b.renderer
                            .symbol(c, r.x, r.y, r.width, r.height, n ? h : f)
                            .add(t)),
        ...
        pointAttribs: function (a, b) {
          ...
          b &&
            ...
            (e = z(
              b.lineWidth,
              c.lineWidth,
              e + z(b.lineWidthPlus, c.lineWidthPlus, 0)
            )),
        ...
        destroy: function () {
          ...
          u(a.axisTypes || [], function (b) {
            (m = a[b]) &&
              m.series &&
              (d(m.series, a), (m.isDirty = m.forceRedraw = !0));
          });
          ...
          for (h in a)
            a[h] instanceof r &&
              !a[h].survive &&
              ((e = c && "group" === h ? "hide" : "destroy"), a[h][e]());
            ...
            d
              ...
              : c.length &&
                ...
                e[3]
                  ? (d.dashstyle = e[3])
                  : "square" !== b.linecap &&
                    (d["stroke-linecap"] = d["stroke-linejoin"] = "round"),
                (d = a[k].attr(d).shadow(2 > g && b.shadow)));
        ...
        applyZones: function () {
          ...
          e.length &&
            ...
            u(e, function (e, k) {
              ...
              g = Math.min(
                Math.max(Math.round(l.toPixels(z(e.value, q.max), !0)), 0),
                r
              );
              ...
              y = Math.max(d, g);
              l.isXAxis
                ? ((h = { x: p ? y : F, y: 0, width: A, height: r }),
                  x || (h.x = b.plotHeight - h.x))
                : ((h = { x: 0, y: p ? y : F, width: r, height: A }),
                  x && (h.y = b.plotWidth - h.y));
              p &&
                c.isVML &&
                (h = l.isXAxis
                  ? { x: 0, y: t ? F : y, height: h.width, width: b.chartWidth }
                  : {
              ...
              f[k]
                ? f[k].animate(h)
                : ((f[k] = c.clipRect(h)),
                  m && a["zone-graph-" + k].clip(f[k]),
                  n && a["zone-area-" + k].clip(f[k]));
              v = e.value > q.max;
            }),
            (this.clips = f));
        },
  ...
  (function (a) {
    ...
    D.prototype = {
      ...
      setOffset: function (a, d) {
        ...
        if ((d = this.label))
          d.align(this.alignOptions, null, h),
            (h = d.alignAttr),
            d[
              !1 === this.options.crop || f.isInsidePlot(h.x, h.y)
                ? "show"
                : "hide"
            ](!0);
      },
    ...
    a.prototype.setStackedPoints = function () {
      if (
        ...
        for (J = 0; J < f; J++)
          (G = a[J]),
            (g = d[J]),
            (A = this.getStackIndicator(A, G, this.index)),
            (C = A.key),
            (w = (k = F && g < (m ? 0 : t)) ? v : q),
            r[w] || (r[w] = {}),
            r[w][G] ||
              (x[w] && x[w][G]
                ? ((r[w][G] = x[w][G]), (r[w][G].total = null))
                : (r[w][G] = new D(e, e.options.stackLabels, k, G, b))),
            (w = r[w][G]),
            null !== g &&
              ((w.points[C] = w.points[this.index] = [l(w.cum, m)]),
              h(w.cum) || (w.base = C),
              (w.touched = e.stacksTouched),
              0 < A.index &&
                !1 === this.singleStacks &&
                (w.points[C][0] = w.points[this.index + "," + G + ",0"][0])),
            "percent" === p
              ? ((k = k ? q : v),
                F && r[k] && r[k][G]
                  ? ((k = r[k][G]),
                    (w.total = k.total =
                      Math.max(k.total, w.total) + Math.abs(g) || 0))
                  : (w.total = I(w.total + (Math.abs(g) || 0))))
              : (w.total = I(w.total + (g || 0))),
            (w.cum = l(w.cum, m) + (g || 0)),
            null !== g && (w.points[C].push(w.cum), (c[J] = w.cum));
      ...
      p([d, "-" + d], function (d) {
        for (var m = f.length, b, n; m--; )
          if (
            ...
            (b = (n = c[d] && c[d][b]) && n.points[h.key]))
          )
            (n = n.total ? 100 / n.total : 0),
              (b[0] = I(b[0] * n)),
              (b[1] = I(b[1] * n)),
              (a.stackedYData[m] = b[1]);
      });
    };
  ...
  (function (a) {
    ...
    l(a.Chart.prototype, {
      addSeries: function (a, b, c) {
        ...
        a &&
          ((b = t(b, !0)),
          u(d, "addSeries", { options: a }, function () {
            e = d.initSeries(a);
            d.isDirtyLegend = !0;
            d.linkSeries();
            b && d.redraw(c);
      ...
      showLoading: function (a) {
        ...
        h(e, l(d.style, { zIndex: 10 }));
        h(b.loadingSpan, d.labelStyle);
        b.loadingShown ||
          (h(e, { opacity: 0, display: "" }),
          C(
            e,
      ...
      update: function (a, b) {
        ...
        if (k) {
          ...
          for (e in k)
            k.hasOwnProperty(e) &&
              (-1 !== d("chart." + e, this.propsRequireUpdateSeries) &&
                (n = !0),
        ...
        e = k && k.width;
        k = k && k.height;
        (c(e) && e !== this.chartWidth) || (c(k) && k !== this.chartHeight)
          ? this.setSize(e, k)
          : t(b, !0) && this.redraw();
      },
    ...
    l(b.prototype, {
      addPoint: function (a, b, c, d) {
        ...
        c &&
          (f[0] && f[0].remove
            ? f[0].remove(!1)
            : (f.shift(), this.updateParallelArrays(g, "shift"), n.shift()));
    ...
    l(G.prototype, {
      ...
      remove: function (a) {
        for (
          var b = this.chart, c = this.coll, e = this.series, d = e.length;
          d--;
      ...
      { softThreshold: !1, threshold: 0 },
      {
        ...
        getGraphPath: function (a) {
          var f = h.prototype.getGraphPath,
            ...
            r = function (c, e, f) {
              ...
              var n,
                ...
                k = !0;
              f || h
                ? ((n = (h ? c[0] : c[1]) + f), (l = c[0] + f), (k = !!h))
                : !p && a[e] && a[e].isNull && (n = l = z);
              void 0 !== n &&
                (t.push({
                  plotX: b,
          ...
          for (c = 0; c < a.length; c++)
            if (
              ((n = a[c].isNull),
              (b = I(a[c].rectPlotX, a[c].plotX)),
              (e = I(a[c].yBottom, F)),
              !n || l)
            )
              l || r(c, c - 1, "left"),
                (n && !p && l) ||
                  (t.push(a[c]), y.push({ x: c, plotX: b, plotY: e })),
                l || r(c, c + 1, "right");
          c = f.call(this, t, !0, !0);
          y.reversed = !0;
          n = f.call(this, y, !0, !0);
        ...
        drawGraph: function () {
          ...
          C(this.zones, function (d, c) {
            u.push([
              "zone-area-" + c,
              "highcharts-area highcharts-zone-area-" + c + " " + d.className,
              d.color || a.color,
              ...
              : ((h = a[c] =
                  a.chart.renderer
                    ...
                    .attr({
                      fill: I(
                        d[3],
                        D(d[2]).setOpacity(I(l.fillOpacity, 0.75)).get()
                      ),
                      zIndex: 0,
                    })
                    .add(a.group)),
      ...
      {},
      {
        getPointSpline: function (a, G, I) {
          ...
          if (
            ...
            d += c;
            l > a && l > f
              ? ((l = Math.max(a, f)), (d = 2 * f - l))
              : l < a && l < f && ((l = Math.min(a, f)), (d = 2 * f - l));
            d > I && d > f
              ? ((d = Math.max(I, f)), (l = 2 * f - d))
              : d < I && d < f && ((d = Math.min(I, f)), (l = 2 * f - d));
            G.rightContX = u;
            G.rightContY = d;
          }
          G = [
            "C",
            D(p.rightContX, p.plotX),
            D(p.rightContY, p.plotY),
            D(v, h),
            D(l, f),
            h,
            f,
      ...
      },
      {
        ...
        getColumnMetrics: function () {
          ...
          var u = Math.min(
            ...
            c = Math.min(
              ...
              p(c.pointWidth, e * (1 - 2 * c.pointPadding))
            );
          a.columnMetrics = {
            width: c,
            offset:
              (e - c) / 2 +
              (F + ((a.columnIndex || 0) + (l ? 1 : 0)) * e - u / 2) *
                (l ? -1 : 1),
          };
        ...
        translate: function () {
          ...
          G(a.points, function (d) {
            ...
            Math.abs(t) < b &&
              b &&
              ((t = b),
              (r = (!l.reversed && !d.negative) || (l.reversed && d.negative)),
              (q = Math.abs(q - m) > b ? f - b : m - (r ? b : 0)));
            d.barX = k;
            d.pointWidth = u;
            d.tooltipPos = c.inverted
              ? [l.len + l.pos - c.plotLeft - h, a.xAxis.len - k - n / 2, t]
              : [k + n / 2, h + l.pos - c.plotTop, t];
            d.shapeType = "rect";
            d.shapeArgs = a.crispCol.apply(
              a,
              d.isNull ? [d.plotX, l.len / 2, 0, 0] : [k, q, n, t]
            );
          });
        },
        getSymbol: a.noop,
        ...
        pointAttribs: function (a, c) {
          ...
          a &&
            this.zones.length &&
            (b =
              ((b = a.getZone()) && b.color) || a.options.color || this.color);
          c &&
            ((a = d.states[c]),
            (c = a.brightness),
            (b =
              a.color ||
              (void 0 !== c && C(b).brighten(a.brightness).get()) ||
              b),
            (l = a[f] || l),
            (p = a[m] || p),
            (h = a.dashStyle || h));
          ...
          G(a.points, function (b) {
            ...
            if (h(b.plotY) && null !== b.y) {
              ...
              if (d) d[c.pointCount < t ? "animate" : "attr"](f(m));
                ...
                b.graphic = d = p[b.shapeType](m)
                  .attr({ class: b.getClassName() })
                  .add(b.group || a.group);
              d.attr(a.pointAttribs(b, b.selected && "select")).shadow(
                l.shadow,
                null,
                l.stacking && !l.borderRadius
              );
          ...
          u &&
            (a
              ? ((m.scaleY = 0.001),
                ...
                h ? (m.translateX = a - d.len) : (m.translateY = a),
                c.group.attr(m))
              : ((m[h ? "translateX" : "translateY"] = d.pos),
                c.group.animate(
                  m,
                  I(D(c.options.animation), {
                    step: function (a, d) {
                      c.group.attr({ scaleY: Math.max(0.001, d.pos) });
                    },
                  })
                ),
                (c.animate = null)));
    ...
    u(
      ...
      },
      {
          ...
          a ||
            (G(d, function (a) {
              var b = a.graphic,
                d = a.shapeArgs;
              b &&
                (b.attr({ r: a.startR || c.center[3] / 2, start: f, end: f }),
                b.animate(
        ...
        updateTotals: function () {
          ...
          for (a = 0; a < h; a++)
            (m = f[a]),
              (m.percentage = 0 < d && (m.visible || !b) ? (m.y / d) * 100 : 0),
              (m.total = d);
        },
        generatePoints: function () {
        ...
        translate: function (a) {
          ...
          var c = 0,
            ...
            F =
              (this.endAngleRad =
                (Math.PI / 180) * (p(d.endAngle, F + 360) - 90)) - e,
            r = this.points,
          ...
          for (A = 0; A < k; A++) {
            ...
            b = (Math.cos(u) * a[2]) / 2;
            l = (Math.sin(u) * a[2]) / 2;
            w.tooltipPos = [a[0] + 0.7 * b, a[1] + 0.7 * l];
        ...
        drawPoints: function () {
          ...
          G(a.points, function (c) {
            if (null !== c.y) {
              ...
              h
                ? h.setRadialReference(a.center).attr(m).animate(I(b, f))
                : ((c.graphic = h =
                    d[c.shapeType](b)
                      .addClass(c.getClassName())
                      .setRadialReference(a.center)
                      .attr(f)
                      .add(a.group)),
                  c.visible || h.attr({ visibility: "hidden" }),
                  h.attr(m).attr({ "stroke-linejoin": "round" }).shadow(l, n));
            }
          });
        },
        searchPoint: f,
      ...
      },
      {
        ...
        setVisible: function (a, d) {
          ...
          a !== c.visible &&
            ...
            (f.options.data[h(c, f.data)] = c.options),
            G(
            ...
            c.legendItem && m.legend.colorizeItem(c, a),
        ...
        haloPath: function (a) {
          ...
          return this.sliced || !this.visible
            ...
            : this.series.chart.renderer.symbols.arc(
                ...
                c.r + a,
                c.r + a,
                { innerR: this.shapeArgs.r, start: c.start, end: c.end }
              );
        },
      }
    );
  ...
  (function (a) {
        ...
        for (d = a.length; d--; )
          (f = a[d]),
            (m =
              ...
              2),
            (f.pos = Math.min(Math.max(0, m - f.size / 2), c - f.size));
        d = a.length;
        for (f = !1; d--; )
          0 < d &&
    ...
    c.prototype.alignDataLabel = function (a, c, b, d, f) {
      var m = this.chart,
        ...
        v =
          this.visible &&
          (a.series.forceDL ||
            m.isInsidePlot(l, Math.round(n), e) ||
            (d && m.isInsidePlot(l, e ? d.x + 1 : d.y + d.height - 1, e))),
        z = "justify" === u(b.overflow, "justify");
      v &&
        ((k = b.style.fontSize),
        (k = m.renderer.fontMetrics(k, c).b),
        (d = h(
          {
            x: e ? m.plotWidth - n : l,
        ...
        h(b, { width: p.width, height: p.height }),
        q
          ? ((z = !1),
            (e = m.renderer.rotCorr(k, q)),
            (e = {
              x: d.x + b.x + d.width / 2 + e.x,
              y:
                d.y +
                b.y +
                { top: 0, middle: 0.5, bottom: 1 }[b.verticalAlign] * d.height,
            }),
            c[f ? "attr" : "animate"](e).attr({ align: t }),
            (l = (q + 720) % 360),
            (l = 180 < l && 360 > l),
            "left" === t
              ? (e.y -= l ? p.height : 0)
              ...
              : "right" === t && ((e.x -= p.width), (e.y -= l ? 0 : p.height)))
          : (c.align(b, null, d), (e = c.alignAttr)),
        z
          ? this.justifyDataLabel(c, b, e, p, d, f)
          : u(b.crop, !0) &&
            (v =
              m.isInsidePlot(e.x, e.y) &&
              m.isInsidePlot(e.x + p.width, e.y + p.height)),
        b.shape && !q && c.attr({ anchorX: a.plotX, anchorY: a.plotY }));
    ...
    c.prototype.justifyDataLabel = function (a, c, b, d, f, h) {
      ...
      n = b.x + d.width - p;
      n > e.plotWidth &&
        ("left" === m ? (c.align = "right") : (c.x = e.plotWidth - n),
        (k = !0));
      n = b.y + p;
      0 > n &&
        ("bottom" === l ? (c.verticalAlign = "top") : (c.y = -n), (k = !0));
      n = b.y + d.height - p;
      n > e.plotHeight &&
        ("top" === l ? (c.verticalAlign = "bottom") : (c.y = e.plotHeight - n),
        (k = !0));
    ...
    n.pie &&
      ((n.pie.prototype.drawDataLabels = function () {
        ...
        d.visible &&
          ...
          I(f, function (a) {
            a.dataLabel &&
              a.visible &&
              (R[a.half].push(a), (a.dataLabel._pos = null));
          }),
          I(R, function (c, e) {
            var f,
              m,
            ...
            if (q)
              for (
                d.sortByAngle(c, e - 0.5),
                  0 < k &&
                    ((f = Math.max(0, D - y - k)),
                    (m = Math.min(D + y + k, h.plotHeight)),
                    (t = p(c, function (a) {
                      if (a.dataLabel)
                        return (
                          (F = a.dataLabel.getBBox().height || 21),
                          {
                ...
                (b = c[Q]),
                  (L = b.labelPos),
                  (g = b.dataLabel),
                  (P = !1 === b.visible ? "hidden" : "inherit"),
                  (u = L[1]),
                  t
                    ? void 0 === t[Q].pos
                      ? (P = "hidden")
                      : ((M = t[Q].size), (H = f + t[Q].pos))
                    : (H = u),
                  (E = l.justify
                    ? w[0] + (e ? -1 : 1) * (y + k)
                    : d.getX(H < f + 2 || H > m - 2 ? u : H, e)),
                  (g._attr = { visibility: P, align: L[6] }),
                  (g._pos = {
                  ...
                  null === d.options.size &&
                    ((B = g.width),
                    E - B < n
                      ? (O[3] = Math.max(Math.round(B - E + n), O[3]))
                      : E + B > r - n &&
                        (O[1] = Math.max(Math.round(E + B - r + n), O[1])),
                    0 > H - M / 2
                      ? (O[0] = Math.max(Math.round(-H + M / 2), O[0]))
                      : H + M / 2 > v &&
                        (O[2] = Math.max(Math.round(H + M / 2 - v), O[2])));
          }),
          0 === C(O) || this.verifyDataLabelOverflow(O)) &&
      ...
      (n.pie.prototype.verifyDataLabelOverflow = function (a) {
        var c = this.center,
          ...
          e;
        null !== f[0]
          ? (l = Math.max(c[2] - Math.max(a[1], a[3]), h))
          : ((l = Math.max(c[2] - a[1] - a[3], h)),
            (c[0] += (a[3] - a[1]) / 2));
        null !== f[1]
          ? (l = Math.max(Math.min(l, c[2] - Math.max(a[0], a[2])), h))
          : ((l = Math.max(Math.min(l, c[2] - a[0] - a[2]), h)),
            (c[1] += (a[0] - a[2]) / 2));
        l < c[2]
          ? ((c[2] = l),
            (c[3] = Math.min(d(b.innerSize || 0, l), l)),
            this.translate(c),
    ...
    n.column &&
      (n.column.prototype.alignDataLabel = function (a, d, b, f, h) {
        ...
        m &&
          ...
          p ||
            (l
              ? ((f.x += n ? 0 : f.width), (f.width = 0))
              : ((f.y += n ? f.height : 0), (f.height = 0))));
        b.align = u(b.align, !l || p ? "center" : n ? "right" : "left");
        b.verticalAlign = u(
          b.verticalAlign,
          l || p ? "middle" : n ? "top" : "bottom"
        );
  ...
  (function (a) {
    ...
    a = a.TrackerMixin = {
      ...
      drawTrackerGraph: function () {
        var a = this,
          ...
          v = "rgba(192,192,192," + (z ? 0.0001 : 0.002) + ")";
        if (f && !c)
          for (g = f + 1; g--; )
            "M" === d[g] && d.splice(g + 1, 0, d[g + 1] - n, d[g + 2], "L"),
              ((g && "M" === d[g]) || g === f) &&
                d.splice(g, 0, "L", d[g - 2] + n, d[g - 1]);
        q
          ? q.attr({ d: d })
          : a.graph &&
            ((a.tracker = m
    ...
    v(C.prototype, {
      ...
      zoom: function (a) {
        ...
        f && !h
          ? this.showResetZoom()
          : !f && c(h) && (this.resetZoomButton = h.destroy());
        b &&
          this.redraw(
            t(
      ...
      pan: function (a, b) {
        ...
        p("xy" === b ? [1, 0] : [1], function (b) {
          ...
          b.series.length &&
            0 > k &&
            0 > g &&
            (b.setExtremes(h, l, !1, !1, { trigger: "pan" }), (d = !0));
          c[e] = f;
        });
        d && c.redraw(!1);
    ...
    v(m.prototype, {
      select: function (a, b) {
        ...
        c.firePointEvent(
          ...
          function () {
            ...
            c.setState(a && "select");
            b ||
              p(f.getSelectedPoints(), function (a) {
                a.selected &&
                  a !== c &&
                  ((a.selected = a.options.selected = !1),
                  (e.options.data[d(a, e.data)] = a.options),
                  a.setState(""),
      ...
      onMouseOver: function (a, b) {
        ...
        if (this.series) {
          ...
          !d || (d.shared && !c.noSharedTooltip)
            ? d || this.setState("hover")
            : (this.setState("hover"), d.refresh(this, a));
            ...
            this.state &&
              ...
              z &&
                this.graphic.animate(
                  z,
                  t(u.options.chart.animation, n.animation, l.animation)
                ),
              g && g.hide();
          else {
            if (a && n) {
              ...
              if (g) g[b ? "animate" : "attr"]({ x: z.x, y: z.y });
              else
                l &&
                  ((e.stateMarkerGraphic = g =
                    u.renderer
                      .symbol(l, z.x, z.y, z.width, z.height)
                      .add(e.markerGroup)),
                  (g.currentSymbol = l));
              g && g.attr(e.pointAttribs(this, a));
            }
            g &&
              (g[a && u.isInsidePlot(c, d, u.inverted) ? "show" : "hide"](),
              (g.element.point = this));
          }
          (c = h.halo) && c.size
            ? (y ||
                (e.halo = y =
                  u.renderer.path().add(F ? e.markerGroup : e.group)),
              y[b ? "animate" : "attr"]({ d: this.haloPath(c.size) }),
              y.attr({
                class:
                  "highcharts-halo highcharts-color-" +
                  t(this.colorIndex, e.colorIndex),
              }),
              (y.point = this),
              y.attr(
                v(
            ...
            : y &&
              y.point &&
              y.point.haloPath &&
              y.animate({ d: y.point.haloPath(0) });
          this.state = a;
        }
      },
      haloPath: function (a) {
    ...
    v(b.prototype, {
      ...
      setState: function (a) {
        ...
        if (
          b.state !== a &&
          (p([b.group, b.markerGroup], function (c) {
            c &&
          ...
          for (f = { "stroke-width": h }, d.attr(f); b["zone-graph-" + c]; )
  ...
  (function (a) {
    ...
    D.prototype.matchResponsiveRule = function (f, v) {
      ...
      d =
        ...
        function () {
          return (
            this.chartWidth <= h(p.maxWidth, Number.MAX_VALUE) &&
            this.chartHeight <= h(p.maxHeight, Number.MAX_VALUE) &&
            this.chartWidth >= h(p.minWidth, 0) &&
            this.chartHeight >= h(p.minHeight, 0)
          );
        };
      ...
      !l[f._id] && d
        ? f.chartOptions &&
          ((l[f._id] = this.currentOptions(f.chartOptions)),
          this.update(f.chartOptions, v))
        : l[f._id] && !d && (this.update(l[f._id], v), delete l[f._id]);
    };
      ...
      function h(a, d, c) {
        ...
        for (l in a)
          if (-1 < G(l, ["series", "xAxis", "yAxis"]))
            for (a[l] = f(a[l]), c[l] = [], p = 0; p < a[l].length; p++)
