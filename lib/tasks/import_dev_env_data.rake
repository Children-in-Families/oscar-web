namespace :import do
    ...
    task dev_env_data: :environment do
      ...
      begin
        Organization.create_and_build_tanent(short_name: tenant_name, full_name: 'Development Environment', logo: File.open(Rails.root.join('app/assets/images/dev-tenant-logo.jpg')))
        ...
        Importer::Import.new('District', general).districts
        Importer::Import.new('Quantitative Type').quantitative_types
        Importer::Import.new('Quantitative Case').quantitative_cases
