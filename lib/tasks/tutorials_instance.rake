namespace :tutorials do
  ...
  task create: :environment do
    org = Organization.create_and_build_tanent(short_name: 'tutorials', full_name: 'Tutorials', country: 'cambodia', logo: File.open(Rails.root.join('app/assets/images/OSCaR.png')))
