namespace :auscam do
  ...
  task import: :environment do
    org = Organization.create_and_build_tenant(short_name: 'auscam', full_name: "Auscam Freedom Project", logo: File.open(Rails.root.join('app/assets/images/auscam.png')))
