          ...
          if district_name
            if rural_postal_code.to_i != 0
              ...
              if rural_commune_name
                district.communes.find_or_initialize_by(name_kh: rural_commune_name, name_en: rural_commune_name, district_type: district_types[1]) do |commune|
                  commune.save(validate: false)
                end
              end
            end
            if urban_postal_code.to_i != 0
