namespace :ajl do
    ...
    task import: :environment do
      ...
      begin
        Organization.create_and_build_tanent(short_name: tenant_name, full_name: 'Anjali House', logo: File.open(Rails.root.join('app/assets/images/anjali logo.png')))
        ...
        AjlImporter::Import.new.import_all
