namespace :lwb do
    ...
    task import: :environment do
      ...
      begin
        Organization.create_and_build_tenant(short_name: tenant_name, full_name: 'Love Without Boundary', logo: File.open(Rails.root.join('app/assets/images/lwb logo.png')))
