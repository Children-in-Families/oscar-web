namespace :mission_worldwide do
  ...
  task import: :environment do
    org = Organization.create_and_build_tenant(short_name: 'tmw', full_name: 'The Mission Worldwide', country: 'cambodia', logo: File.open(Rails.root.join('app/assets/images/TMWUK.png')))
