namespace :fit do
    ...
    task import: :environment do
      ...
      begin
        Organization.create_and_build_tenant(short_name: tenant_name, full_name: 'Friend International', logo: File.open(Rails.root.join('app/assets/images/fi logo.jpg')))
