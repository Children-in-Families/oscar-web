namespace :cfi do
  ...
  task import: :environment do
    org = Organization.create_and_build_tenant(short_name: 'cfi', full_name: "Children's Future International", logo: File.open(Rails.root.join('app/assets/images/cfi.png')))
