...
Rails.application.routes.draw do
  ...
  constraints format: :js do
    ...
    get '/dashboards/user_filter_overdue_custom_assessments' => 'dashboards#user_filter_overdue_custom_assessments'
    get '/dashboards/user_filter_overdue_custom_forms' => 'dashboards#user_filter_overdue_custom_forms'
