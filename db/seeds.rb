...
User.create_with(first_name: 'OSCaR', last_name: 'Team', roles: 'admin', gender: 'female', enable_gov_log_in: true, enable_research_log_in: true, referral_notification: true, password: ENV['OSCAR_TEAM_PASSWORD']).find_or_create_by(email: ENV['OSCAR_TEAM_EMAIL'])
