class AddCustomCsiNameToSettings < ActiveRecord::Migration
  def up
    add_column :settings, :custom_assessment, :string, default: 'Custom CSI'
    ...
    add_column :settings, :default_assessment, :string, default: 'Default CSI'
  ...
  def down
    remove_column :settings, :custom_assessment, :string, default: 'Custom CSI'
    ...
    remove_column :settings, :default_assessment, :string, default: 'Default CSI'
