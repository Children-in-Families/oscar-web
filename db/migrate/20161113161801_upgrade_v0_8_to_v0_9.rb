...
class UpgradeV08ToV09 < Thredded::BaseMigration
  ...
  def down
    add_column :thredded_user_preferences, :notify_on_message, :boolean, default: true, null: false if !column_exists? :thredded_user_preferences, :notify_on_message
    add_column :thredded_user_preferences, :followed_topic_emails, :boolean, default: true, null: false if !column_exists? :thredded_user_preferences, :followed_topic_emails
    add_column :thredded_user_messageboard_preferences, :followed_topic_emails, :boolean, default: true, null: false if !column_exists? :thredded_user_preferences, :followed_topic_emails
