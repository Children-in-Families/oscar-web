  ...
  def change
    reversible do |dir|
      dir.up do
        if schema_search_path == "\"public\""
          execute <<-SQL.squish
            ...
            GRANT EXECUTE ON FUNCTION "public"."fn_oscar_dashboard_quantitative_cases"() TO "#{ENV['POWER_BI_GROUP']}";
          SQL
        end
      end
      ...
      dir.down do
        if schema_search_path == "\"public\""
          execute <<-SQL.squish
            REVOKE EXECUTE ON FUNCTION "public"."fn_oscar_dashboard_quantitative_cases"() FROM "#{ENV['POWER_BI_GROUP']}";
