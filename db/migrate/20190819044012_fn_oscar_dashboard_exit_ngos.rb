              ...
              BEGIN
                ...
                LOOP
                  ...
                  sql := sql || format(
                                  ...
                                  FROM %1$I.%2$s INNER JOIN %1$I.clients ON %1$I.clients.id = %1$I.exit_ngos.client_id
                                  ...
                                  WHERE %1$I.exit_ngos.deleted_at IS NULL AND %1$I.sponsors.donor_id IN (%3$s) UNION ',
                                  sch.short_name, 'exit_ngos', donor_sql);
                END LOOP;
